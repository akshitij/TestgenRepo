...
#pragma merger("0","./binaryToGray.i","-g,-g")
extern int scanf(char const * __restrict __format , ...) __asm__("__isoc99_scanf") ;
int power(int power_num , int power_pow___0 )
{
  int power_tmp ;
  int power___cil_tmp4 ;
  int power___cil_tmp5 ;
  int power___cil_tmp6 ;
  char *symName ;
  void *addr ;
  char in[15] ;
  ...
  {
  if (power_pow___0) {
    power___cil_tmp6 = power_pow___0 - 1;
    handleAssignmentSymbolically("power___cil_tmp6", "(- power_pow___0 1)", & power___cil_tmp6,
                                 & power___cil_tmp6, 1);
    funcEntry("(int,power_num,variable,power_num)#(int,power_pow___0,variable,power___cil_tmp6)",
              "power_tmp power___cil_tmp4 power___cil_tmp5 power___cil_tmp6", "power");
    power_tmp = power(power_num, power___cil_tmp6);
    funcExit();
    add_entryToSTable("power_tmp", ret_SymValue, ret_ConValue, & power_tmp, 1);
    {
    power___cil_tmp4 = power_num * power_tmp;
    handleAssignmentSymbolically("power___cil_tmp4", "(* power_num power_tmp)", & power___cil_tmp4,
                                 & power___cil_tmp4, 1);
    {
    mapConcolicValues("power___cil_tmp4", & power___cil_tmp4);
    return (power___cil_tmp4);
    }
    }
  }
  {
  power___cil_tmp5 = 1;
  add_entryToSTable("power___cil_tmp5", "Constant", & power___cil_tmp5, & power___cil_tmp5,
                    1);
  {
  mapConcolicValues("power___cil_tmp5", & power___cil_tmp5);
  return (power___cil_tmp5);
  }
  }
}
}
...
int main1(void)
{
  ...
  {
  printf((char const * __restrict )"Enter a binary number: ");
  scanf((char const * __restrict )"%d", & bin);
  gray = bintogray(bin);
  printf((char const * __restrict )"The gray code of %d is %d\n", bin, gray);
  return (0);
}
}
void createCDG(void)
{
  ...
  setArray(14, "(! b)");
  addtoCDGnode(17, 13, 0);
  setArray(17, "(! a)");
  addtoCDGnode(15, 14, 1);
  addtoCDGnode(16, 14, 0);
  addtoCDGnode(20, 11, 1);
  addtoCDGnode(17, 14, 0);
  setArray(17, "(! a)");
  ...
  setArray(24, "(! b)");
  addtoCDGnode(27, 23, 0);
  setArray(27, "(! a)");
  addtoCDGnode(25, 24, 1);
  addtoCDGnode(26, 24, 0);
  addtoCDGnode(30, 21, 1);
  addtoCDGnode(27, 24, 0);
  setArray(27, "(! a)");
...
void createSidTable(void)
{
  ...
  {
  add_condition(14, "(not b)", "b", 0, 0);
  add_condition(18, "b", "(not b)", 0, 0);
  add_condition(17, "(not a)", "a", 0, 0);
  add_condition(13, "a", "(not a)", 0, 0);
  add_condition(11, "(! (= bin 0))", "(not (! (= bin 0)))", 0, 0);
  add_condition(24, "(not b)", "b", 0, 0);
  add_condition(28, "b", "(not b)", 0, 0);
  add_condition(27, "(not a)", "a", 0, 0);
  add_condition(23, "a", "(not a)", 0, 0);
  add_condition(21, "(! (= bin 0))", "(not (! (= bin 0)))", 0, 0);
}
}
struct arguments {
   int bin ;
...
int bintogray(int bin )
{
  ...
  sprintf(__cil_tmp12, "\t%d\n", bin);
  printTestCase("binaryToGray_bintogray_1434828862.tc", __cil_tmp12);
  add_entryToSTable("bin", "s0", & bin, & bin, 1);
  result = 0;
  add_entryToSTable("result", "Constant", & result, & result, 1);
  i___0 = 0;
  add_entryToSTable("i___0", "Constant", & i___0, & i___0, 1);
  {
  {
  exp_outcome = bin != 0;
  handleAssignmentSymbolically("exp_outcome", "(! (= bin 0))", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(11, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(11, 1, 0);
    setTrueExpr(11, "(not (= bin 0))");
    setFalseExpr(11, "(not (not (= bin 0)))");
    addToTree(11, 1, "(not (= bin 0))", "(not (not (= bin 0)))", 0, 1);
    delete_allVariableTableEntry();
    a = bin % 10;
    handleAssignmentSymbolically("a", "(% bin 10)", & a, & a, 1);
    bin /= 10;
    handleAssignmentSymbolically("bin", "(/ bin 10)", & bin, & bin, 1);
    b = bin % 10;
    handleAssignmentSymbolically("b", "(% bin 10)", & b, & b, 1);
    {
    exp_outcome = a;
    handleAssignmentSymbolically("exp_outcome", "a", & a, & a, 1);
    overall_outcome = (int )getConditionalOutcome(13, exp_outcome);
    if (overall_outcome) {
      setBranchInfo(13, 1, 0);
      setTrueExpr(13, "a");
      setFalseExpr(13, "(not a)");
      addToTree(13, 2, "a", "(not a)", 11, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = ! b;
      handleAssignmentSymbolically("exp_outcome", "(! b)", & exp_outcome, & exp_outcome,
                                   1);
      overall_outcome = (int )getConditionalOutcome(14, exp_outcome);
      if (overall_outcome) {
        setBranchInfo(14, 1, 0);
        setTrueExpr(14, "(not b)");
        setFalseExpr(14, "b");
        addToTree(14, 3, "(not b)", "b", 13, 1);
        delete_allVariableTableEntry();
        __cil_tmp7 = 10;
        add_entryToSTable("__cil_tmp7", "Constant", & __cil_tmp7, & __cil_tmp7, 1);
        funcEntry("(int,power_num,variable,__cil_tmp7)#(int,power_pow___0,variable,i___0)",
                  "power_tmp power___cil_tmp4 power___cil_tmp5 power___cil_tmp6",
                  "power");
        tmp = power(__cil_tmp7, i___0);
        funcExit();
        add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 1);
        result += tmp;
        handleAssignmentSymbolically("result", "(+ result tmp)", & result, & result,
                                     1);
      } else {
        setBranchInfo(14, 0, 1);
        setTrueExpr(14, "(not b)");
        setFalseExpr(14, "b");
        addToTree(14, 3, "(not b)", "b", 13, 0);
        delete_allVariableTableEntry();
        goto _L01;
      }
      }
      ...
      setTrueExpr(13, "a");
      setFalseExpr(13, "(not a)");
      addToTree(13, 2, "a", "(not a)", 11, 0);
      delete_allVariableTableEntry();
      _L01:
      {
      exp_outcome = ! a;
      handleAssignmentSymbolically("exp_outcome", "(! a)", & exp_outcome, & exp_outcome,
                                   1);
      overall_outcome = (int )getConditionalOutcome(17, exp_outcome);
      if (overall_outcome) {
        setBranchInfo(17, 1, 0);
        setTrueExpr(17, "(not a)");
        setFalseExpr(17, "a");
        addToTree(17, 3, "(not a)", "a", 13, 1);
        delete_allVariableTableEntry();
        {
        exp_outcome = b;
        handleAssignmentSymbolically("exp_outcome", "b", & b, & b, 1);
        overall_outcome = (int )getConditionalOutcome(18, exp_outcome);
        if (overall_outcome) {
          setBranchInfo(18, 1, 0);
          setTrueExpr(18, "b");
          setFalseExpr(18, "(not b)");
          addToTree(18, 4, "b", "(not b)", 17, 1);
          delete_allVariableTableEntry();
          __cil_tmp8 = 10;
          add_entryToSTable("__cil_tmp8", "Constant", & __cil_tmp8, & __cil_tmp8,
                            1);
          funcEntry("(int,power_num,variable,__cil_tmp8)#(int,power_pow___0,variable,i___0)",
                    "power_tmp power___cil_tmp4 power___cil_tmp5 power___cil_tmp6",
                    "power");
          tmp = power(__cil_tmp8, i___0);
          funcExit();
          add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 1);
          result += tmp;
          handleAssignmentSymbolically("result", "(+ result tmp)", & result, & result,
    ...
    setTrueExpr(11, "(not (= bin 0))");
    setFalseExpr(11, "(not (not (= bin 0)))");
    addToTree(11, 1, "(not (= bin 0))", "(not (not (= bin 0)))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  {
  ...
  if (overall_outcome) {
    ...
    setTrueExpr(21, "(not (= bin 0))");
    setFalseExpr(21, "(not (not (= bin 0)))");
    addToTree(21, 1, "(not (= bin 0))", "(not (not (= bin 0)))", 0, 1);
    delete_allVariableTableEntry();
    a = bin % 10;
    handleAssignmentSymbolically("a", "(% bin 10)", & a, & a, 1);
    bin /= 10;
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(23, "a");
      setFalseExpr(23, "(not a)");
      addToTree(23, 2, "a", "(not a)", 21, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = ! b;
      handleAssignmentSymbolically("exp_outcome", "(! b)", & exp_outcome, & exp_outcome,
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(24, "(not b)");
        setFalseExpr(24, "b");
        addToTree(24, 3, "(not b)", "b", 23, 1);
        delete_allVariableTableEntry();
        __cil_tmp7 = 10;
        add_entryToSTable("__cil_tmp7", "Constant", & __cil_tmp7, & __cil_tmp7, 1);
        funcEntry("(int,power_num,variable,__cil_tmp7)#(int,power_pow___0,variable,i___0)",
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(27, "(not a)");
        setFalseExpr(27, "a");
        addToTree(27, 3, "(not a)", "a", 23, 1);
        delete_allVariableTableEntry();
        {
        exp_outcome = b;
        handleAssignmentSymbolically("exp_outcome", "b", & b, & b, 1);
        ...
        if (overall_outcome) {
          ...
          setTrueExpr(28, "b");
          setFalseExpr(28, "(not b)");
          addToTree(28, 4, "b", "(not b)", 27, 1);
          delete_allVariableTableEntry();
          __cil_tmp8 = 10;
          add_entryToSTable("__cil_tmp8", "Constant", & __cil_tmp8, & __cil_tmp8,
                            1);
    ...
    setTrueExpr(21, "(not (= bin 0))");
    setFalseExpr(21, "(not (not (= bin 0)))");
    addToTree(21, 1, "(not (= bin 0))", "(not (not (= bin 0)))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
