...
1                        & primemod                          & 66                & 2                            & 1.010 sec  & 100		& 4			& 1.219 sec   \\[0ex] 
  &	(main) & & & & & & \\ [1ex]\hline
2                        & TCAS-1             & 14                & 11                            & 1.009 sec  & 85 		& 9 		& 1.240 sec  \\ [1ex]
  &	(Non\_Crossing\_Biased\_Descend) & & & & & & \\ [1ex]\hline
3                        & TCAS-2                   & 33                & 8                            & 0.998 sec   & 83		& 7		 & 1.289 sec \\[1ex] 
  &	(Non\_Crossing\_Biased\_Climb) & & & & & & \\ [1ex]\hline
4                        & heapSort                          & 100                & 2                            & 0.900 sec  & 100		& 2			& 1.143 sec    \\[1ex] 
  &	(heapSort) & & & & & & \\ [1ex]\hline
5                        & crest1                          & 50                & 1                            & 0.915 sec  & 100		& 2			& 1.108 sec   \\[1ex] 
  &	(main) & & & & & & \\ [1ex]\hline
6                        & crest2             & 50                & 1                            & 1.048 sec  & 50		& 1		& 1.191 sec   \\[1ex] 
  &	(main) & & & & & & \\ [1ex]\hline
7                        & prime                    & 83                & 3                            & 1.029 sec   & 50		& 2			& 1.243 sec  \\[1ex] 
  &	(prime) & & & & & & \\ [1ex]\hline
...
\begin{thebibliography}{}
  ...
  \bibitem{cilapi} CIL-Infrastructure for C Program Analysis and Transformation  {\em http://www.cs.berkeley.edu/~necula/cil/api/Cil.html}. 
  \bibitem{cil} \textit{https://www.cs.berkeley.edu/~necula/cil/}
  \bibitem{concolicTesting} Koushik Sen \textit {Concolic Testing}, EECS Department, UC Berkeley, CA, USA
  \bibitem{dart} \textit{DART : Directed Automated Random Testing} Patrice Godefroid, Nils Klarlund, Koushik Sen , Bell Laboratories, Lucent Technologies, University of Illinois at Urbana-Champaign
  \bibitem{cute} \textit{CUTE : A Concolic Unit Testing Engine For C 13th ACM SIGSOFT international symposium jointly with 10th European Software engineering conference} Koushik Sen, Darko Marinov, Gul Agha, University of illinois.
  \bibitem{concolicEngine} Automatic Generation Of Test Cases For High MCDC Coverage \em{www.cse.iitk.ac.in/users/karkare/MTP/2013-14/sonam2014testgen.pdf}
  \bibitem{time} GNU time {\em http://man7.org/linux/man-pages/man1/time.1.html}.
  \bibitem{decadeslater} \em{Symbolic Execution for Software Testing : Three Decades Later} Koushik Sen, Cristian Cadar, Imperial College London, University of California Berkley.
  \bibitem{pnueli} \textit{Two Approaches To Interprocedural Dataflow Analysis} Micha Sharir and Amir Pnueli, Computer Science Department, New York University
  \bibitem{ipa1} Techniques for Interprocedural Analysis \textit{http://pages.cs.wisc.edu/$\sim$fischer/cs701.f14/6.INTERPROCEDURAL-ANALYSIS.html\#app4}\\
  \textit{http://www.cs.cornell.edu/courses/cs4120/2011fa/lectures/lec31-fa11.pdf}
  \bibitem{ipa2} Motivation for Interprocedural Analysis\textit{www.cs.colostate.edu/~mstrout/CS553Fall09/Slides/lecture21-interproc.ppt.pdf}
  
  \newpage
  \bibitem{callstring} Slide for Call String Approach \textit{http://nptel.ac.in/courses/106108052/module20/interproc-a.pdf}
  \bibitem{callstring2} Interprocedural Analysis \textit{http://dragonbook.stanford.edu/lecture-notes/Columbia-COMS-W4117/07-10-16.html} 
  \bibitem{coverage} Code Coverage \textit{https://en.wikipedia.org/wiki/Code\_coverage}
  \bibitem{z3} Z3-Constraint Solver. \textit{http://z3.codeplex.com/}
  \bibitem{random} Random Testing \textit{http://www.slideshare.net/cankaya07/random-testing-15393318}
  \bibitem{tcas} TCAS Benchmark \textit{http://www.irit.fr/wiki/lib/exe/fetch.php?media=wtc:benchmarks:tcas:tcas-b\_volatile.txt}
  \bibitem{mcdc} \textit{Automatic Generation of Test Input data for MC/DC test coverage} Zeina Awedikian, Soccer Lab, Ecole Polytechnique de Montreal.
