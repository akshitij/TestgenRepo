...
#pragma merger("0","./arrayTest2.i","-g,-g")
...
void createCDG(void)
{
  ...
  addtoCDGnode(4, 0, 1);
  addtoCDGnode(5, 0, 1);
  setArray(5, "(< i___0 size)");
  addtoCDGnode(6, 5, 1);
  addtoCDGnode(7, 0, 1);
  setArray(7, "(< i___0 size)");
  addtoCDGnode(7, 0, 1);
  setArray(7, "(< i___0 size)");
  addtoCDGnode(8, 7, 1);
  addtoCDGnode(9, 0, 1);
...
void createSidTable(void)
{
  ...
  {
  add_condition(5, "(< i___0 size)", "(not (< i___0 size))", 0, 0);
  add_condition(7, "(< i___0 size)", "(not (< i___0 size))", 0, 0);
  add_condition(9, "(= b[1] 13)", "(not (= b[1] 13))", 0, 0);
}
}
struct arguments {
   int size ;
...
int main1(int size , int b[10] )
{
  ...
  sprintf(__cil_tmp9, "\t%d\t%d\t%d\t%d\t%d\t%d\n", size, b[0], b[1], b[2], b[3],
          b[4]);
  printTestCase("arrayTest2_main1_1434669532.tc", __cil_tmp9);
  ...
  {
  {
  exp_outcome = i___0 < size;
  handleAssignmentSymbolically("exp_outcome", "(< i___0 size)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(5, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(5, 1, 0);
    setTrueExpr(5, "(< i___0 size)");
    setFalseExpr(5, "(not (< i___0 size))");
    addToTree(5, 1, "(< i___0 size)", "(not (< i___0 size))", 0, 1);
    delete_allVariableTableEntry();
    b[i___0] = 3 * b[i___0] + 1;
    addEntryToVariableTable("b[i___0]", i___0);
    add_entryToArraySTable("b", i___0, "b20", & b[i___0], & b[i___0], 1);
    handleArraySymbolically("b", i___0, "3 * b[i___0] + 1", & b[i___0], & b[i___0],
                            1);
    i___0 ++;
    ...
    setTrueExpr(5, "(< i___0 size)");
    setFalseExpr(5, "(not (< i___0 size))");
    addToTree(5, 1, "(< i___0 size)", "(not (< i___0 size))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  {
  ...
  if (overall_outcome) {
    setBranchInfo(7, 1, 0);
    setTrueExpr(7, "(< i___0 size)");
    setFalseExpr(7, "(not (< i___0 size))");
    addToTree(7, 1, "(< i___0 size)", "(not (< i___0 size))", 0, 1);
    delete_allVariableTableEntry();
    b[i___0] = 3 * b[i___0] + 1;
    addEntryToVariableTable("b[i___0]", i___0);
    add_entryToArraySTable("b", i___0, "b21", & b[i___0], & b[i___0], 1);
    handleArraySymbolically("b", i___0, "3 * b[i___0] + 1", & b[i___0], & b[i___0],
                            1);
    i___0 ++;
    handleAssignmentSymbolically("i___0", "(+ i___0 1)", & i___0, & i___0, 1);
    ...
    setTrueExpr(7, "(< i___0 size)");
    setFalseExpr(7, "(not (< i___0 size))");
    addToTree(7, 1, "(< i___0 size)", "(not (< i___0 size))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
  ...
  if (overall_outcome) {
    ...
    setBranchInfo(9, 1, 0);
    setTrueExpr(9, "(= b[1] 13)");
    setFalseExpr(9, "(not (= b[1] 13))");
    addToTree(9, 1, "(= b[1] 13)", "(not (= b[1] 13))", 0, 1);
    delete_allVariableTableEntry();
    j = 1;
    ...
    setTrueExpr(9, "(= b[1] 13)");
    setFalseExpr(9, "(not (= b[1] 13))");
    addToTree(9, 1, "(= b[1] 13)", "(not (= b[1] 13))", 0, 0);
    delete_allVariableTableEntry();
    j = -1;
    add_entryToSTable("j", "Constant", & j, & j, 1);
  }
