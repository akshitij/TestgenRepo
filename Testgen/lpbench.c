...
static  int N   = 1000;
static  int NM1 =  999; // N - 1
static  int NP1 = 1001; // N + 1
#else
static  int N   =  600;
static  int NM1 =  599; // N - 1
static  int NP1 =  601; // N + 1
#endif
#else
#ifdef SMALL_PROBLEM_SIZE
static  int N   = 400;
static  int NM1 = 399; // N - 1
static  int NP1 = 401; // N + 1
#else
static  int N   = 2000;
static  int NM1 = 1999; // N - 1
static  int NP1 = 2001; // N + 1
#endif
#endif
