...
void createCDG(void)
{
  ...
  addtoCDGnode(5, 0, 1);
  addtoCDGnode(6, 0, 1);
  setArray(6, "(<= i___0 (/ n 2))");
  addtoCDGnode(7, 6, 1);
  addtoCDGnode(11, 0, 1);
  setArray(11, "(<= i___0 (/ n 2))");
  addtoCDGnode(8, 6, 1);
  setArray(8, "(= d 0)");
  addtoCDGnode(9, 8, 1);
  addtoCDGnode(10, 6, 1);
...
void createSidTable(void)
{
  ...
  add_condition(6, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 0);
  add_condition(13, "(= d 0)", "(not (= d 0))", 0, 0);
  add_condition(11, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 0);
  add_condition(16, "(= flag 0)", "(not (= flag 0))", 0, 0);
}
}
struct arguments {
   int n ;
...
int main1(int n )
{
  ...
  sprintf(__cil_tmp10, "\t%d\n", n);
  printTestCase("prime2_main1_1434838374.tc", __cil_tmp10);
  ...
  {
  {
  exp_outcome = i___0 <= n / 2;
  handleAssignmentSymbolically("exp_outcome", "(<= i___0 (/ n 2))", & exp_outcome,
                               & exp_outcome, 1);
  overall_outcome = (int )getConditionalOutcome(6, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(6, 1, 0);
    setTrueExpr(6, "(<= i___0 (/ n 2))");
    setFalseExpr(6, "(not (<= i___0 (/ n 2)))");
    addToTree(6, 1, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 1);
    delete_allVariableTableEntry();
    funcEntry("(int,_divides_n,variable,i___0)#(int,_divides_m,variable,n)", "_divides___cil_tmp3",
              "_divides");
    tmp = _divides(i___0, n);
    funcExit();
    add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 1);
    d = tmp;
    handleAssignmentSymbolically("d", "tmp", & tmp, & tmp, 1);
    {
    exp_outcome = d == 0;
    ...
    setTrueExpr(6, "(<= i___0 (/ n 2))");
    setFalseExpr(6, "(not (<= i___0 (/ n 2)))");
    addToTree(6, 1, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  {
  ...
  if (overall_outcome) {
    ...
    setTrueExpr(11, "(<= i___0 (/ n 2))");
    setFalseExpr(11, "(not (<= i___0 (/ n 2)))");
    addToTree(11, 1, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 1);
    delete_allVariableTableEntry();
    funcEntry("(int,_divides_n,variable,i___0)#(int,_divides_m,variable,n)", "_divides___cil_tmp3",
              "_divides");
    tmp = _divides(i___0, n);
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(13, "(= d 0)");
      setFalseExpr(13, "(not (= d 0))");
      addToTree(13, 2, "(= d 0)", "(not (= d 0))", 11, 1);
      delete_allVariableTableEntry();
      flag = 1;
      add_entryToSTable("flag", "Constant", & flag, & flag, 1);
    } else {
      ...
      setTrueExpr(13, "(= d 0)");
      setFalseExpr(13, "(not (= d 0))");
      addToTree(13, 2, "(= d 0)", "(not (= d 0))", 11, 0);
      delete_allVariableTableEntry();
    }
    }
    i___0 ++;
    ...
    setTrueExpr(11, "(<= i___0 (/ n 2))");
    setFalseExpr(11, "(not (<= i___0 (/ n 2)))");
    addToTree(11, 1, "(<= i___0 (/ n 2))", "(not (<= i___0 (/ n 2)))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
  {
  exp_outcome = flag == 0;
  handleAssignmentSymbolically("exp_outcome", "(= flag 0)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(16, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(16, 1, 0);
    setTrueExpr(16, "(= flag 0)");
    setFalseExpr(16, "(not (= flag 0))");
    addToTree(16, 1, "(= flag 0)", "(not (= flag 0))", 0, 1);
    delete_allVariableTableEntry();
    printf((char const * __restrict )"%d is a prime number.\n", n);
  } else {
    setBranchInfo(16, 0, 1);
    setTrueExpr(16, "(= flag 0)");
    setFalseExpr(16, "(not (= flag 0))");
    addToTree(16, 1, "(= flag 0)", "(not (= flag 0))", 0, 0);
    delete_allVariableTableEntry();
    printf((char const * __restrict )"%d is not a prime number.\n", n);
  }
  }
  {
  __cil_tmp6 = 0;
