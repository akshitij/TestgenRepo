...
int getOccurence(char *funcName )
{
  ...
  while (1) {
    ...
    b___0 = (funcVars *)tmp___3;
    stackPop(backup, & b___0);
    stackPush(symStack, & b___0);
  }
  return (occ);
}
}
...
#pragma merger("0","./globalVerify.i","-g,-g")
...
void createSidTable(void)
{
  ...
  {
  add_condition(2, "(= a 51)", "(not (= a 51))", 0, 0);
}
}
struct arguments {
   int a ;
...
int main1(int global_a , int global_b )
{
  int b___0 ;
  int __cil_tmp2 ;
  int exp_outcome ;
  ...
  printTestCase("globalVerify_main1_1435664131.tc", __cil_tmp6);
  ...
  if (overall_outcome) {
    setBranchInfo(2, 1, 0);
    setTrueExpr(2, "(= a 51)");
    setFalseExpr(2, "(not (= a 51))");
    addToTree(2, 1, "(= a 51)", "(not (= a 51))", 0, 1);
    delete_allVariableTableEntry();
    b___0 = 1;
    add_entryToSTable("b___0", "Constant", & b___0, & b___0, 1);
  } else {
    setBranchInfo(2, 0, 1);
    setTrueExpr(2, "(= a 51)");
    setFalseExpr(2, "(not (= a 51))");
    addToTree(2, 1, "(= a 51)", "(not (= a 51))", 0, 0);
    delete_allVariableTableEntry();
    b___0 = 2;
    add_entryToSTable("b___0", "Constant", & b___0, & b___0, 1);
  }
