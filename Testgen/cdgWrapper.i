...
# 6 "src/src/cdgWrapper.c" 2



CDGNode *nodes[500] = { ((void *)0) };

CDGNode *root = ((void *)0);

CDGNode *savePath = ((void *)0);
CDGContext ctx;
CDGPath *pathHead;
CDGPath *newSATPath;
int pathRank = 0;
...
void addtoCDGnode(int id, int pid, int branch) {
  ...
  if (nodes[id] != ((void *)0) && nodes[id]->parent != ((void *)0) && nodes[id]->parent->id == pid) {
    return;
  }
...
int getMaxFeasible() {
  ...
  new_head = newNode(currPath->node->id, currPath->node->score, currPath->node->outcome, currPath->node->expr, ((void *)0), ((void *)0), ((void *)0), ((void *)0));
...
# 355 "src/src/cdgWrapper.c"
  ...
  if (result[0] != '\0') {
    ...
    while (token != ((void *)0)) {
     ...
     while (i < infeasible) {
 new_curr = newNode(curr->id, curr->score, curr->outcome, curr->expr, ((void *)0), ((void *)0), save, ((void *)0));
 save->next = new_curr;
 save = new_curr;
 curr = curr->next;
         i++;
