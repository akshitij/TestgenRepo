...
#pragma merger("0","./arrayTest1.i","-g,-g")
extern int scanf(char const * __restrict __format , ...) __asm__("__isoc99_scanf") ;
int foo(int *foo_a , int foo_n )
{
  int foo_i___0 ;
  int foo___cil_tmp4 ;
  char *symName ;
  ...
  {
  foo_i___0 = 0;
  add_entryToSTable("foo_i___0", "Constant", & foo_i___0, & foo_i___0, 1);
  foo_i___0 = 0;
  add_entryToSTable("foo_i___0", "Constant", & foo_i___0, & foo_i___0, 1);
  {
  if (foo_i___0 < foo_n) {
    *(foo_a + foo_i___0) = 3 * *(foo_a + foo_i___0) + 1;
    addEntryToVariableTable("*(foo_a + foo_i___0)", foo_i___0);
    add_entryToArraySTable("foo_a", foo_i___0, "foo_a10", foo_a + foo_i___0, foo_a + foo_i___0,
                           1);
    handleArraySymbolically("foo_a", foo_i___0, "(+ (* 3 *(foo_a + foo_i___0)) 1)",
                            foo_a + foo_i___0, foo_a + foo_i___0, 1);
    foo_i___0 ++;
    handleAssignmentSymbolically("foo_i___0", "(+ foo_i___0 1)", & foo_i___0, & foo_i___0,
                                 1);
  }
  if (foo_i___0 < foo_n) {
    *(foo_a + foo_i___0) = 3 * *(foo_a + foo_i___0) + 1;
    addEntryToVariableTable("*(foo_a + foo_i___0)", foo_i___0);
    add_entryToArraySTable("foo_a", foo_i___0, "foo_a11", foo_a + foo_i___0, foo_a + foo_i___0,
                           1);
    handleArraySymbolically("foo_a", foo_i___0, "(+ (* 3 *(foo_a + foo_i___0)) 1)",
                            foo_a + foo_i___0, foo_a + foo_i___0, 1);
    foo_i___0 ++;
  ...
  {
  foo___cil_tmp4 = 0;
  add_entryToSTable("foo___cil_tmp4", "Constant", & foo___cil_tmp4, & foo___cil_tmp4,
                    1);
  {
  mapConcolicValues("foo___cil_tmp4", & foo___cil_tmp4);
  return (foo___cil_tmp4);
  }
  }
}
}
...
void createSidTable(void)
{
  ...
  {
  add_condition(13, "(= b[1] 13)", "(not (= b[1] 13))", 0, 0);
}
}
struct arguments {
   int size ;
...
int main1(int size , int b[10] )
{
  ...
  sprintf(__cil_tmp10, "\t%d\t%d\t%d\t%d\t%d\t%d\n", size, b[0], b[1], b[2], b[3],
          b[4]);
  printTestCase("arrayTest1_main1_1434669632.tc", __cil_tmp10);
  add_entryToSTable("size", "s0", & size, & size, 1);
  printf((char const * __restrict )"----------------------------------EXECUTION START------------------------\n");
  i___0 = 0;
  add_entryToSTable("i___0", "Constant", & i___0, & i___0, 1);

  __cil_tmp6 = b;
  handleAssignmentSymbolically("__cil_tmp6", "b", & __cil_tmp6, & __cil_tmp6, 1);
  funcEntry("(int *,foo_a,variable,__cil_tmp6)#(int,foo_n,variable,size)", "foo_i___0 foo___cil_tmp4",
            "foo");
  foo(__cil_tmp6, size);
  funcExit();
  {
  exp_outcome = b[1] == 13;
  addEntryToVariableTable("b[1]", 1);
  add_entryToArraySTable("b", 1, "b22", & b[1], & b[1], 1);
  handleAssignmentSymbolically("exp_outcome", "(= b[1] 13)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(13, exp_outcome);
  if (overall_outcome) {
    addEntryToVariableTable("b[1]", 1);
    add_entryToArraySTable("b", 1, "b10", & b[1], & b[1], 1);
    setBranchInfo(13, 1, 0);
    setTrueExpr(13, "(= b[1] 13)");
    setFalseExpr(13, "(not (= b[1] 13))");
    addToTree(13, 1, "(= b[1] 13)", "(not (= b[1] 13))", 0, 1);
    delete_allVariableTableEntry();
    j = 1;
    ...
    setTrueExpr(13, "(= b[1] 13)");
    setFalseExpr(13, "(not (= b[1] 13))");
    addToTree(13, 1, "(= b[1] 13)", "(not (= b[1] 13))", 0, 0);
    delete_allVariableTableEntry();
    j = -1;
    add_entryToSTable("j", "Constant", & j, & j, 1);
  }
...
void main(void)
{
  ...
  while (1) {
    if (__cil_tmp3 >= 10) {
      ...
      __cil_tmp2 = rand();
      argvar.b[__cil_tmp3] = __cil_tmp2 % 20;
      __cil_tmp3 ++;
    }
  }
  initSID();
