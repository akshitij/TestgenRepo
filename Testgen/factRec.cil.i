...
int fact(int fact_x , int fact_y )
{
  ...
  if (fact_y <= 1) {
    ...
    handleAssignmentSymbolically("fact___cil_tmp7", "(- fact_y 1)", & fact___cil_tmp7,
                                 & fact___cil_tmp7, 1);
    funcEntry("(int,fact_x,variable,fact___cil_tmp6) (int,fact_y,variable,fact___cil_tmp7)",
    ...
    handleAssignmentSymbolically("fact___cil_tmp5", "(* fact_x fact_tmp)", & fact___cil_tmp5,
                                 & fact___cil_tmp5, 1);
    {
    mapConcolicValues("fact___cil_tmp5", & fact___cil_tmp5);
...
int main1(int a )
{
  ...
  printTestCase("factRec_main1_1434119003.tc", __cil_tmp8);
  add_entryToSTable("a", "s0", & a, & a, 1);
  b = 3;
  add_entryToSTable("b", "Constant", & b, & b, 1);
  funcEntry("(int,fact_x,variable,a) (int,fact_y,variable,b)", "fact_tmp fact___cil_tmp4 fact___cil_tmp5 fact___cil_tmp6 fact___cil_tmp7",
            "fact");
  a = fact(a, b);
  funcExit();
