...
#pragma merger("0","./fp-convert.i","-g,-g")
double loop(float *loop_x , float *loop_y , long loop_length )
{
  long loop_i___0 ;
  double loop_accumulator ;
  char *symName ;
  void *addr ;
  char in[15] ;

  {
  loop_accumulator = 0.0;
  add_entryToSTable("loop_accumulator", "Constant", & loop_accumulator, & loop_accumulator,
                    2);
  loop_i___0 = 0L;
  add_entryToSTable("loop_i___0", "Constant", & loop_i___0, & loop_i___0, 1);
  {
  if (loop_i___0 < loop_length) {
    loop_accumulator += (double )*(loop_x + loop_i___0) * (double )*(loop_y + loop_i___0);
    handleAssignmentSymbolically("loop_accumulator", "(+ loop_accumulator (* *(loop_x + loop_i___0) *(loop_y + loop_i___0)))",
                                 & loop_accumulator, & loop_accumulator, 2);
    loop_i___0 ++;
    handleAssignmentSymbolically("loop_i___0", "(+ loop_i___0 1L)", & loop_i___0,
                                 & loop_i___0, 1);
  }
  if (loop_i___0 < loop_length) {
    loop_accumulator += (double )*(loop_x + loop_i___0) * (double )*(loop_y + loop_i___0);
  ...
  {
  mapConcolicValues("loop_accumulator", & loop_accumulator);
...
void createCDG(void)
{
  ...
  addtoCDGnode(2, 0, 1);
  addtoCDGnode(3, 0, 1);
  setArray(3, "(< i___0 500000)");
  addtoCDGnode(4, 3, 1);
  setArray(4, "(% i___0 10)");
  addtoCDGnode(14, 0, 1);
  setArray(14, "(< i___0 500000)");
  addtoCDGnode(5, 4, 1);
  addtoCDGnode(6, 4, 0);
  addtoCDGnode(7, 3, 1);
  addtoCDGnode(7, 3, 1);
  ...
  setArray(15, "(% i___0 10)");
  addtoCDGnode(25, 0, 1);
  addtoCDGnode(16, 15, 1);
  addtoCDGnode(17, 15, 0);
  addtoCDGnode(18, 14, 1);
  addtoCDGnode(18, 14, 1);
  addtoCDGnode(19, 14, 1);
  addtoCDGnode(20, 14, 1);
  setArray(20, "(< j 2048)");
  addtoCDGnode(21, 20, 1);
  addtoCDGnode(22, 14, 1);
  setArray(22, "(< j 2048)");
  addtoCDGnode(22, 14, 1);
  setArray(22, "(< j 2048)");
  addtoCDGnode(23, 22, 1);
  addtoCDGnode(24, 14, 1);
  addtoCDGnode(24, 14, 1);
  addtoCDGnode(25, 0, 1);
  addtoCDGnode(26, 0, 1);
  addtoCDGnode(27, 0, 1);
...
void createSidTable(void)
{
  ...
  {
  add_condition(4, "(% i___0 10)", "(not (% i___0 10))", 0, 0);
  add_condition(9, "(< j 2048)", "(not (< j 2048))", 0, 0);
  add_condition(11, "(< j 2048)", "(not (< j 2048))", 0, 0);
  add_condition(3, "(< i___0 500000)", "(not (< i___0 500000))", 0, 0);
  add_condition(15, "(% i___0 10)", "(not (% i___0 10))", 0, 0);
  add_condition(20, "(< j 2048)", "(not (< j 2048))", 0, 0);
  add_condition(22, "(< j 2048)", "(not (< j 2048))", 0, 0);
  add_condition(14, "(< i___0 500000)", "(not (< i___0 500000))", 0, 0);
}
}
struct arguments {
   float x[2048] ;
...
int main1(float x[2048] , float y[2048] , int argc , char **argv )
{
  int i___0 ;
  int j ;
  double total ;
  ...
  sprintf(__cil_tmp18, "\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%d\n", x[0], x[1],
          x[2], x[3], x[4], y[0], y[1], y[2], y[3], y[4], argc);
  printTestCase("fp-convert_main1_1435772043.tc", __cil_tmp18);
  add_entryToSTable("argv", "s3", & argv, & argv, 1);
  add_entryToSTable("argc", "s2", & argc, & argc, 1);
  total = 0.0;
  add_entryToSTable("total", "Constant", & total, & total, 2);
  a = 0.0f;
  add_entryToSTable("a", "Constant", & a, & a, 2);
  b = 1.0f;
  add_entryToSTable("b", "Constant", & b, & b, 2);
  i___0 = 0;
  add_entryToSTable("i___0", "Constant", & i___0, & i___0, 1);
  {
  {
  exp_outcome = i___0 < 500000;
  handleAssignmentSymbolically("exp_outcome", "(< i___0 500000)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(3, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(3, 1, 0);
    setTrueExpr(3, "(< i___0 500000)");
    setFalseExpr(3, "(not (< i___0 500000))");
    addToTree(3, 1, "(< i___0 500000)", "(not (< i___0 500000))", 0, 1);
    delete_allVariableTableEntry();
    {
    ...
    if (overall_outcome) {
      setBranchInfo(4, 1, 0);
      setTrueExpr(4, "(% i___0 10)");
      setFalseExpr(4, "(not (% i___0 10))");
      addToTree(4, 2, "(% i___0 10)", "(not (% i___0 10))", 3, 1);
      delete_allVariableTableEntry();
      a = 0.0f;
      add_entryToSTable("a", "Constant", & a, & a, 2);
      b = 1.0f;
      ...
      setTrueExpr(4, "(% i___0 10)");
      setFalseExpr(4, "(not (% i___0 10))");
      addToTree(4, 2, "(% i___0 10)", "(not (% i___0 10))", 3, 0);
      delete_allVariableTableEntry();
      a += 0.1f;
      handleAssignmentSymbolically("a", "(+ a 0.1f)", & a, & a, 2);
      b += 0.2f;
      handleAssignmentSymbolically("b", "(+ b 0.2f)", & b, & b, 2);
    }
    }
    j = 0;
    ...
    {
    exp_outcome = j < 2048;
    handleAssignmentSymbolically("exp_outcome", "(< j 2048)", & exp_outcome, & exp_outcome,
                                 1);
    overall_outcome = (int )getConditionalOutcome(9, exp_outcome);
    if (overall_outcome) {
      setBranchInfo(9, 1, 0);
      setTrueExpr(9, "(< j 2048)");
      setFalseExpr(9, "(not (< j 2048))");
      addToTree(9, 2, "(< j 2048)", "(not (< j 2048))", 3, 1);
      delete_allVariableTableEntry();
      x[j] = a + (float )j;
      handleArraySymbolically("x", j, "a + (float )j", & x[j], & x[j], 2);
      y[j] = b + (float )j;
      handleArraySymbolically("y", j, "b + (float )j", & y[j], & y[j], 2);
      j ++;
      ...
      setTrueExpr(9, "(< j 2048)");
      setFalseExpr(9, "(not (< j 2048))");
      addToTree(9, 2, "(< j 2048)", "(not (< j 2048))", 3, 0);
      delete_allVariableTableEntry();
    }
    }
    {
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(11, "(< j 2048)");
      setFalseExpr(11, "(not (< j 2048))");
      addToTree(11, 2, "(< j 2048)", "(not (< j 2048))", 3, 1);
      delete_allVariableTableEntry();
      x[j] = a + (float )j;
      handleArraySymbolically("x", j, "a + (float )j", & x[j], & x[j], 2);
      y[j] = b + (float )j;
      ...
      setTrueExpr(11, "(< j 2048)");
      setFalseExpr(11, "(not (< j 2048))");
      addToTree(11, 2, "(< j 2048)", "(not (< j 2048))", 3, 0);
      delete_allVariableTableEntry();
    }
    }
    }
    __cil_tmp12 = x;
    handleAssignmentSymbolically("__cil_tmp12", "x", & __cil_tmp12, & __cil_tmp12,
                                 1);
    __cil_tmp13 = y;
    handleAssignmentSymbolically("__cil_tmp13", "y", & __cil_tmp13, & __cil_tmp13,
                                 1);
    __cil_tmp14 = 2048L;
    add_entryToSTable("__cil_tmp14", "Constant", & __cil_tmp14, & __cil_tmp14, 1);
    funcEntry("(float *,loop_x,pointer,__cil_tmp12)#(float *,loop_y,pointer,__cil_tmp13)#(long,loop_length,variable,__cil_tmp14)",
              "loop_i___0 loop_accumulator", "loop");
    tmp = loop(__cil_tmp12, __cil_tmp13, __cil_tmp14);
    funcExit();
    add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 2);
    total += tmp;
    handleAssignmentSymbolically("total", "(+ total tmp)", & total, & total, 2);
    i___0 ++;
    ...
    setTrueExpr(3, "(< i___0 500000)");
    setFalseExpr(3, "(not (< i___0 500000))");
    addToTree(3, 1, "(< i___0 500000)", "(not (< i___0 500000))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  {
  ...
  if (overall_outcome) {
    ...
    setTrueExpr(14, "(< i___0 500000)");
    setFalseExpr(14, "(not (< i___0 500000))");
    addToTree(14, 1, "(< i___0 500000)", "(not (< i___0 500000))", 0, 1);
    delete_allVariableTableEntry();
    {
    exp_outcome = i___0 % 10;
    handleAssignmentSymbolically("exp_outcome", "(% i___0 10)", & exp_outcome, & exp_outcome,
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(15, "(% i___0 10)");
      setFalseExpr(15, "(not (% i___0 10))");
      addToTree(15, 2, "(% i___0 10)", "(not (% i___0 10))", 14, 1);
      delete_allVariableTableEntry();
      a = 0.0f;
      add_entryToSTable("a", "Constant", & a, & a, 2);
      b = 1.0f;
      ...
      setTrueExpr(15, "(% i___0 10)");
      setFalseExpr(15, "(not (% i___0 10))");
      addToTree(15, 2, "(% i___0 10)", "(not (% i___0 10))", 14, 0);
      delete_allVariableTableEntry();
      a += 0.1f;
      handleAssignmentSymbolically("a", "(+ a 0.1f)", & a, & a, 2);
      b += 0.2f;
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(20, "(< j 2048)");
      setFalseExpr(20, "(not (< j 2048))");
      addToTree(20, 2, "(< j 2048)", "(not (< j 2048))", 14, 1);
      delete_allVariableTableEntry();
      x[j] = a + (float )j;
      handleArraySymbolically("x", j, "a + (float )j", & x[j], & x[j], 2);
      y[j] = b + (float )j;
      ...
      setTrueExpr(20, "(< j 2048)");
      setFalseExpr(20, "(not (< j 2048))");
      addToTree(20, 2, "(< j 2048)", "(not (< j 2048))", 14, 0);
      delete_allVariableTableEntry();
    }
    }
    {
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(22, "(< j 2048)");
      setFalseExpr(22, "(not (< j 2048))");
      addToTree(22, 2, "(< j 2048)", "(not (< j 2048))", 14, 1);
      delete_allVariableTableEntry();
      x[j] = a + (float )j;
      handleArraySymbolically("x", j, "a + (float )j", & x[j], & x[j], 2);
      y[j] = b + (float )j;
      ...
      setTrueExpr(22, "(< j 2048)");
      setFalseExpr(22, "(not (< j 2048))");
      addToTree(22, 2, "(< j 2048)", "(not (< j 2048))", 14, 0);
      delete_allVariableTableEntry();
    }
    }
    }
    ...
    setTrueExpr(14, "(< i___0 500000)");
    setFalseExpr(14, "(not (< i___0 500000))");
    addToTree(14, 1, "(< i___0 500000)", "(not (< i___0 500000))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
  printf((char const * __restrict )"Total is %g\n", total);
  {
  __cil_tmp11 = 0;
  add_entryToSTable("__cil_tmp11", "Constant", & __cil_tmp11, & __cil_tmp11, 1);
...
void callInstrumentedFun(void)
{
  ...
  {
  enQueue();
  main1(argvar.x, argvar.y, argvar.argc, argvar.argv);
}
}
void main(void)
{
  ...
  while (1) {
    if (__cil_tmp7 >= 2048) {
      ...
      __cil_tmp6 = rand();
      argvar.x[__cil_tmp7] = __cil_tmp6 % 20;
      __cil_tmp7 ++;
    }
  }
  __cil_tmp5 = 0;
  while (1) {
    if (__cil_tmp5 >= 2048) {
      ...
      __cil_tmp4 = rand();
      argvar.y[__cil_tmp5] = __cil_tmp4 % 20;
      __cil_tmp5 ++;
    }
  }
  __cil_tmp3 = rand();
  argvar.argc = __cil_tmp3 % 20;
  argvar.argv = (char **)malloc(30 * sizeof(char *));
  __cil_tmp2 = 0;
  while (1) {
    if (__cil_tmp2 >= 30) {
      break;
      ...
      temp = rand();
      *(argvar.argv + __cil_tmp2) = temp % 20;
      __cil_tmp2 ++;
    }
  }
  initSID();
