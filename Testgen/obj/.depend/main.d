 $(OBJDIR)/main.cmo $(OBJDIR)/:   $(OBJDIR)/vartype.cmo   $(OBJDIR)/varUpdated.cmo  $(OBJDIR)/util.cmi \
      ...
      $(OBJDIR)/partial.cmo   $(OBJDIR)/param.cmo   $(OBJDIR)/oneret.cmi \
      $(OBJDIR)/modifyVars.cmo  $(OBJDIR)/mergecil.cmi   $(OBJDIR)/makeCDG.cmo \
 ...
 $(OBJDIR)/main.cmx $(OBJDIR)/:   $(OBJDIR)/vartype.cmx   $(OBJDIR)/varUpdated.cmx  $(OBJDIR)/util.cmx \
      ...
      $(OBJDIR)/partial.cmx   $(OBJDIR)/param.cmx   $(OBJDIR)/oneret.cmx \
      $(OBJDIR)/modifyVars.cmx  $(OBJDIR)/mergecil.cmx   $(OBJDIR)/makeCDG.cmx \
