...
#pragma merger("0","./constant.i","-g,-g")
...
int main1(int a )
{
  ...
  printTestCase("constant_main1_1433407644.tc", __cil_tmp8);
  add_entryToSTable("a", "s0", & a, & a, 1);
  x = 6;
  add_entryToSTable("x", "Constant", & x, & x, 1);
  y = 1;
  add_entryToSTable("y", "Constant", & y, & y, 1);
  a = a * x + y;
  handleAssignmentSymbolically("a", "(+ (* a x) y)", & a, & a, 1);
  {
  exp_outcome = a == 31;
