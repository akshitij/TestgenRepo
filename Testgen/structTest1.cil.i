...
#pragma merger("0","./structTest1.i","-g,-g")
node___0 n ;
void createCDG(void)
{
...
void createSidTable(void)
{
  ...
  {
  add_condition(4, "(= a_1 6)", "(not (= a_1 6))", 0, 0);
}
}
struct arguments {
   node___0 n ;
...
int main1(node___0 global_n )
{
  ...
  sprintf(__cil_tmp9, "\n");
  printTestCase("structTest1_main1_1435576784.tc", __cil_tmp9);
  add_entryToSTable("n", "s0", & n, & n, -1);
  a_0 = n.a;
  store(& n, "a", 1, & n.a, "structVar0");
  symName = getSymName(& n, "a");
  add_entryToSTable("a_0", symName, & a_0, & a_0, 1);
  n.a = 3 * a_0;
  {
  a_1 = n.a;
  store(& n, "a", 1, & n.a, "structVar1");
  symName = getSymName(& n, "a");
  add_entryToSTable("a_1", symName, & a_1, & a_1, 1);
  {
  exp_outcome = a_1 == 6;
  handleAssignmentSymbolically("exp_outcome", "(= a_1 6)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(4, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(4, 1, 0);
    setTrueExpr(4, "(= a_1 6)");
    setFalseExpr(4, "(not (= a_1 6))");
    addToTree(4, 1, "(= a_1 6)", "(not (= a_1 6))", 0, 1);
    delete_allVariableTableEntry();
    j = 1;
    ...
    setTrueExpr(4, "(= a_1 6)");
    setFalseExpr(4, "(not (= a_1 6))");
    addToTree(4, 1, "(= a_1 6)", "(not (= a_1 6))", 0, 0);
    delete_allVariableTableEntry();
    j = -1;
    add_entryToSTable("j", "Constant", & j, & j, 1);
  }
