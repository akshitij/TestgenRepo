...
void createSidTable(void)
{
  ...
  {
  add_condition(2, "(= main_a 45)", "(not (= main_a 45))", 0, 0);
}
}
struct arguments {
   int main_a ;
...
int main1(int main_a )
{
  ...
  printTestCase("tripleVerify_main1_1433504110.tc", __cil_tmp6);
  add_entryToSTable("main_a", "s0", & main_a, & main_a, 1);
  main_a = 3 * main_a;
  handleAssignmentSymbolically("main_a", "(* 3 main_a)", & main_a, & main_a, 1);
  {
  ...
  if (overall_outcome) {
    setBranchInfo(2, 1, 0);
    setTrueExpr(2, "(= main_a 45)");
    setFalseExpr(2, "(not (= main_a 45))");
    addToTree(2, 1, "(= main_a 45)", "(not (= main_a 45))", 0, 1);
    delete_allVariableTableEntry();
    main_b = 1;
    ...
    setTrueExpr(2, "(= main_a 45)");
    setFalseExpr(2, "(not (= main_a 45))");
    addToTree(2, 1, "(= main_a 45)", "(not (= main_a 45))", 0, 0);
    delete_allVariableTableEntry();
    main_b = -1;
    add_entryToSTable("main_b", "Constant", & main_b, & main_b, 1);
  }
