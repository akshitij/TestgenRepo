...
{ 
  ...
  *mult_a *= 3;
  ...
  handleAssignmentSymbolically("*mult_a", "(* *mult_a 3)", mult_a, mult_a, 1);
  *mult_b *= 4;
  addEntryToVariableTable("*mult_b", 1);
  handleAssignmentSymbolically("*mult_b", "(* *mult_b 4)", mult_b, mult_b, 1);
  return;
}
}
void createCDG(void) 
...
{ 
  ...
  printTestCase("pointerTestFunc_main1_1435189319.tc", __cil_tmp10);
