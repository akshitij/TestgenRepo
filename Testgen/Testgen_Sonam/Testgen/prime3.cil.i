...
int prime(int n )
{
  ...
  if (overall_outcome) {
    ...
    {
    __cil_tmp3 = n == 2;
    handleAssignmentSymbolically("__cil_tmp3", "(= n 2)", & __cil_tmp3, & __cil_tmp3,
                                 1);
  ...
  {
  __cil_tmp5 = n > 1;
  handleAssignmentSymbolically("__cil_tmp5", "(> n 1)", & __cil_tmp5, & __cil_tmp5,
                               1);
  __cil_tmp8 = isNotQueueEmpty();
  if (__cil_tmp8) {
    enQueue();
