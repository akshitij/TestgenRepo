...
float eval_A(int eval_A_i___0 , int eval_A_j )
{
  ...
  {
  mapConcolicValues("eval_A___cil_tmp3", & eval_A___cil_tmp3);
  return (eval_A___cil_tmp3);
  }
  }
}
}
void eval_A_times_u(int eval_A_times_u_N , float *eval_A_times_u_u , float *eval_A_times_u_Au )
{
  ...
  {
  eval_A_times_u_i___0 = 0;
  add_entryToSTable("eval_A_times_u_i___0", "Constant", & eval_A_times_u_i___0, & eval_A_times_u_i___0,
                    1);
  {
  if (eval_A_times_u_i___0 < eval_A_times_u_N) {
    *(eval_A_times_u_Au + eval_A_times_u_i___0) = (float )0;
    add_entryToArraySTable("eval_A_times_u_Au", eval_A_times_u_i___0, "Constant",
                           ...
                           2);
    eval_A_times_u_j = 0;
    add_entryToSTable("eval_A_times_u_j", "Constant", & eval_A_times_u_j, & eval_A_times_u_j,
                      1);
    {
    if (eval_A_times_u_j < eval_A_times_u_N) {
      *(eval_A_times_u_Au + eval_A_times_u_i___0) += *(eval_A_times_u_u + eval_A_times_u_j);
      addEntryToVariableTable("*(eval_A_times_u_Au + eval_A_times_u_i___0)", eval_A_times_u_i___0);
      add_entryToArraySTable("eval_A_times_u_Au", eval_A_times_u_i___0, "eval_A_times_u_Au10",
                             eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
                             1);
      addEntryToVariableTable("*(eval_A_times_u_u + eval_A_times_u_j)", eval_A_times_u_j);
      add_entryToArraySTable("eval_A_times_u_u", eval_A_times_u_j, "eval_A_times_u_u11",
                             eval_A_times_u_u + eval_A_times_u_j, eval_A_times_u_u + eval_A_times_u_j,
                             1);
      handleArraySymbolically("eval_A_times_u_Au", eval_A_times_u_i___0, "(+ *(eval_A_times_u_Au + eval_A_times_u_i___0) *(eval_A_times_u_u + eval_A_times_u_j))",
                              eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
                              2);
      eval_A_times_u_j ++;
      handleAssignmentSymbolically("eval_A_times_u_j", "(+ eval_A_times_u_j 1)", & eval_A_times_u_j,
                                   & eval_A_times_u_j, 1);
    }
    if (eval_A_times_u_j < eval_A_times_u_N) {
      *(eval_A_times_u_Au + eval_A_times_u_i___0) += *(eval_A_times_u_u + eval_A_times_u_j);
      addEntryToVariableTable("*(eval_A_times_u_Au + eval_A_times_u_i___0)", eval_A_times_u_i___0);
      add_entryToArraySTable("eval_A_times_u_Au", eval_A_times_u_i___0, "eval_A_times_u_Au12",
                             eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
                             1);
      addEntryToVariableTable("*(eval_A_times_u_u + eval_A_times_u_j)", eval_A_times_u_j);
      add_entryToArraySTable("eval_A_times_u_u", eval_A_times_u_j, "eval_A_times_u_u13",
                             eval_A_times_u_u + eval_A_times_u_j, eval_A_times_u_u + eval_A_times_u_j,
                             1);
      handleArraySymbolically("eval_A_times_u_Au", eval_A_times_u_i___0, "(+ *(eval_A_times_u_Au + eval_A_times_u_i___0) *(eval_A_times_u_u + eval_A_times_u_j))",
                              eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
    ...
    eval_A_times_u_i___0 ++;
    handleAssignmentSymbolically("eval_A_times_u_i___0", "(+ eval_A_times_u_i___0 1)",
  ...
  if (eval_A_times_u_i___0 < eval_A_times_u_N) {
    *(eval_A_times_u_Au + eval_A_times_u_i___0) = (float )0;
    ...
    if (eval_A_times_u_j < eval_A_times_u_N) {
      *(eval_A_times_u_Au + eval_A_times_u_i___0) += *(eval_A_times_u_u + eval_A_times_u_j);
      addEntryToVariableTable("*(eval_A_times_u_Au + eval_A_times_u_i___0)", eval_A_times_u_i___0);
      add_entryToArraySTable("eval_A_times_u_Au", eval_A_times_u_i___0, "eval_A_times_u_Au14",
                             eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
                             1);
      addEntryToVariableTable("*(eval_A_times_u_u + eval_A_times_u_j)", eval_A_times_u_j);
      add_entryToArraySTable("eval_A_times_u_u", eval_A_times_u_j, "eval_A_times_u_u15",
                             eval_A_times_u_u + eval_A_times_u_j, eval_A_times_u_u + eval_A_times_u_j,
                             1);
      handleArraySymbolically("eval_A_times_u_Au", eval_A_times_u_i___0, "(+ *(eval_A_times_u_Au + eval_A_times_u_i___0) *(eval_A_times_u_u + eval_A_times_u_j))",
                              eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
    ...
    if (eval_A_times_u_j < eval_A_times_u_N) {
      *(eval_A_times_u_Au + eval_A_times_u_i___0) += *(eval_A_times_u_u + eval_A_times_u_j);
      addEntryToVariableTable("*(eval_A_times_u_Au + eval_A_times_u_i___0)", eval_A_times_u_i___0);
      add_entryToArraySTable("eval_A_times_u_Au", eval_A_times_u_i___0, "eval_A_times_u_Au16",
                             eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
                             1);
      addEntryToVariableTable("*(eval_A_times_u_u + eval_A_times_u_j)", eval_A_times_u_j);
      add_entryToArraySTable("eval_A_times_u_u", eval_A_times_u_j, "eval_A_times_u_u17",
                             eval_A_times_u_u + eval_A_times_u_j, eval_A_times_u_u + eval_A_times_u_j,
                             1);
      handleArraySymbolically("eval_A_times_u_Au", eval_A_times_u_i___0, "(+ *(eval_A_times_u_Au + eval_A_times_u_i___0) *(eval_A_times_u_u + eval_A_times_u_j))",
                              eval_A_times_u_Au + eval_A_times_u_i___0, eval_A_times_u_Au + eval_A_times_u_i___0,
...
void eval_At_times_u(int eval_At_times_u_N , float *eval_At_times_u_u , float *eval_At_times_u_Au )
{
  int eval_At_times_u_i___0 ;
  int eval_At_times_u_j ;
  float eval_At_times_u_tmp ;
  char *symName ;
  void *addr ;
  char in[15] ;
  ...
  if (eval_At_times_u_i___0 < eval_At_times_u_N) {
    *(eval_At_times_u_Au + eval_At_times_u_i___0) = (float )0;
...
void eval_AtA_times_u(int N , float *u , float *AtAu )
{
  ...
  sprintf(__cil_tmp10, "\t%d\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\t%f\n", N, u[0],
          u[1], u[2], u[3], u[4], AtAu[0], AtAu[1], AtAu[2], AtAu[3], AtAu[4]);
  printTestCase("spectral-norm_eval_AtA_times_u_1436251010.tc", __cil_tmp10);
  add_entryToArraySTable("AtAu", 0, "AtAu_0", AtAu, AtAu, 0);
  ...
  v = (float *)tmp;
  handleAssignmentSymbolically("v", "tmp", & v, & v, 1);
  funcEntry("(int,eval_A_times_u_N,variable,N)#(float *,eval_A_times_u_u,array,u)#(float *,eval_A_times_u_Au,array,v)",
            "eval_A_times_u_i___0 eval_A_times_u_j", "eval_A_times_u");
  eval_A_times_u(N, u, v);
  funcExit();
  funcEntry("(int,eval_At_times_u_N,variable,N)#(float *,eval_At_times_u_u,array,v)#(float *,eval_At_times_u_Au,array,AtAu)",
...
void callInstrumentedFun(void)
{
  ...
  {
  enQueue();
  eval_AtA_times_u(argvar.N, argvar.u, argvar.AtAu);
}
}
void main(void)
{
  ...
  argvar.AtAu = (float *)malloc(30 * sizeof(float ));
  __cil_tmp2 = 0;
  while (1) {
    if (__cil_tmp2 >= 30) {
      break;
      ...
      temp = rand();
      *(argvar.AtAu + __cil_tmp2) = temp % 20;
      __cil_tmp2 ++;
    }
  }
  initSID();
