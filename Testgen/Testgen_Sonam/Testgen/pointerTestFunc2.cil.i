...
#pragma merger("0","./pointerTestFunc2.i","-g,-g")
...
int main1(int num1 , int num2 )
{
  ...
  printTestCase("pointerTestFunc2_main1_1435191320.tc", __cil_tmp10);
  add_entryToSTable("num2", "s1", & num2, & num2, 1);
  add_entryToSTable("num1", "s0", & num1, & num1, 1);
  __cil_tmp5 = & num1;
  add_entryToSTable("__cil_tmp5", "addr_num1", & __cil_tmp5, & __cil_tmp5, 1);
  add_entryToSTable("addr_num1", "num1", & num1, & num1, 1);
  __cil_tmp6 = & num2;
  add_entryToSTable("__cil_tmp6", "addr_num2", & __cil_tmp6, & __cil_tmp6, 1);
  add_entryToSTable("addr_num2", "num2", & num2, & num2, 1);
  funcEntry("(int *,swap_num1,pointer,__cil_tmp5)#(int *,swap_num2,pointer,__cil_tmp6)",
            "swap_temp", "swap");
  swap(__cil_tmp5, __cil_tmp6);
  funcExit();
  {
  ...
  printf((char const * __restrict )"First number  : %d\n", num1);
  printf((char const * __restrict )"Second number : %d\n", num2);
  {
  __cil_tmp4 = 0;
...
void main(void)
{
  ...
  {
  __cil_tmp3 = rand();
  argvar.num1 = __cil_tmp3 % 20;
  __cil_tmp2 = rand();
  argvar.num2 = __cil_tmp2 % 20;
  initSID();
  isCopyOfHolder();
  createCDG();
  createSidTable();
