...
void createSidTable(void)
{
  ...
  {
  add_condition(2, "(= num1 num2)", "(not (= num1 num2))", 0, 0);
}
}
struct arguments {
   int num1 ;
...
int main1(int num1 , int num2 )
{
  ...
  printTestCase("pointerTestFunc_main1_1435433473.tc", __cil_tmp10);
  add_entryToSTable("num2", "s1", & num2, & num2, 1);
  add_entryToSTable("num1", "s0", & num1, & num1, 1);
  p = & num1;
  add_entryToSTable("p", "addr_num1", & p, & p, 1);
  ...
  if (overall_outcome) {
    setBranchInfo(2, 1, 0);
    setTrueExpr(2, "(= num1 num2)");
    setFalseExpr(2, "(not (= num1 num2))");
    addToTree(2, 1, "(= num1 num2)", "(not (= num1 num2))", 0, 1);
    delete_allVariableTableEntry();
    j = 1;
    ...
    setTrueExpr(2, "(= num1 num2)");
    setFalseExpr(2, "(not (= num1 num2))");
    addToTree(2, 1, "(= num1 num2)", "(not (= num1 num2))", 0, 0);
    delete_allVariableTableEntry();
    j = -1;
    add_entryToSTable("j", "Constant", & j, & j, 1);
  }
