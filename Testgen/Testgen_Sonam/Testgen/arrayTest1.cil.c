...
{ 
  ...
  if (foo_i___0 < foo_n) {
    *(foo_a + foo_i___0) = 3 * *(foo_a + foo_i___0) + 1;
    addEntryToVariableTable("*(__cil_tmp6 + foo_i___0)", foo_i___0);
    add_entryToArraySTable("__cil_tmp6", foo_i___0, "foo_a10", foo_a + foo_i___0, foo_a + foo_i___0,
                           1);
    handleArraySymbolically("__cil_tmp6", foo_i___0, "(+ (* 3 *(__cil_tmp6 + foo_i___0)) 1)",
  ...
  if (foo_i___0 < foo_n) {
    *(foo_a + foo_i___0) = 3 * *(foo_a + foo_i___0) + 1;
    addEntryToVariableTable("*(__cil_tmp6 + foo_i___0)", foo_i___0);
    add_entryToArraySTable("__cil_tmp6", foo_i___0, "foo_a11", foo_a + foo_i___0, foo_a + foo_i___0,
                           1);
    handleArraySymbolically("__cil_tmp6", foo_i___0, "(+ (* 3 *(__cil_tmp6 + foo_i___0)) 1)",
                            foo_a + foo_i___0, foo_a + foo_i___0, 1);
    foo_i___0 ++;
