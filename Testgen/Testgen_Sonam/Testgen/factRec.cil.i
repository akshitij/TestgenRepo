...
int fact(int fact_n )
{
  ...
  if (fact_n <= 1) {
    ...
    funcExit();
    {
    fact___cil_tmp4 = fact_n * fact_tmp;
    handleAssignmentSymbolically("fact___cil_tmp4", "(* fact_n fact_tmp)", & fact___cil_tmp4,
                                 & fact___cil_tmp4, 1);
    {
...
void createSidTable(void)
{
  ...
  {
  add_condition(10, "(= a 24)", "(not (= a 24))", 0, 0);
}
}
struct arguments {
   int a ;
...
int main1(int a )
{
  ...
  {
  exp_outcome = a == 24;
  handleAssignmentSymbolically("exp_outcome", "(= a 24)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(10, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(10, 1, 0);
    setTrueExpr(10, "(= a 24)");
    setFalseExpr(10, "(not (= a 24))");
    addToTree(10, 1, "(= a 24)", "(not (= a 24))", 0, 1);
    delete_allVariableTableEntry();
    b = 1;
    ...
    setTrueExpr(10, "(= a 24)");
    setFalseExpr(10, "(not (= a 24))");
    addToTree(10, 1, "(= a 24)", "(not (= a 24))", 0, 0);
    delete_allVariableTableEntry();
    b = -1;
    add_entryToSTable("b", "Constant", & b, & b, 1);
  }
