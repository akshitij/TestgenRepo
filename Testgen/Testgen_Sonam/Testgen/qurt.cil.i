...
void populateSTable(funcArg *a___0 )
{
  char tmp[5] ;
  char key[55] ;
  char *sym ;
  ...
  strcpy((char * __restrict )(key), (char const * __restrict )(a___0->vname));
  strcat((char * __restrict )(key), (char const * __restrict )(tmp));
  if (a___0->structure == 1) {
    add_entryToSTable(key, (char *)"Constant", a___0->val, a___0->val, a___0->type);
    printf((char const * __restrict )"%s Constant\n", key);
    add_vnameHash(a___0->vname, key);
  } else
  if (a___0->structure == 0) {
    goto _L;
  } else
  if (a___0->structure == 2) {
    _L:
    if ((unsigned long )symStack == (unsigned long )((void *)0)) {
      sym = find_symVal(a___0->apname);
      val = find_conVal(a___0->apname);
    } else {
      ...
      if (tmp___2 == 0) {
        ...
        tmp___0 = get_vnameHash(a___0->apname);
        sym = find_symVal(tmp___0);
        tmp___1 = get_vnameHash(a___0->apname);
        val = find_conVal(tmp___1);
      }
    }
    add_entryToSTable(key, sym, val, val, a___0->type);
    printf((char const * __restrict )"%s %s %d\n", key, sym, *((int *)val));
    add_vnameHash(a___0->vname, key);
  } else
  if ((unsigned long )symStack == (unsigned long )((void *)0)) {
    add_vnameHash(a___0->vname, a___0->apname);
  } else {
    tmp___4 = stackSize(symStack);
    if (tmp___4 == 0) {
      add_vnameHash(a___0->vname, a___0->apname);
    } else {
      tmp___3 = get_vnameHash(a___0->apname);
      add_vnameHash(a___0->vname, tmp___3);
    }
  }
  return;
}
    ...
    *flag___0 = 1;
    ...
    if (tmp___8 != 0) {
      ...
      while (i___0 < count) {
        ...
        tmp___7 = size;
        size ++;
        *(varNames + tmp___7) = a___0->vname;
        populateSTable(a___0);
        i___0 ++;
      }
      free((void *)copy);
    }
    ...
    flag___1 = (int *)tmp___21;
    *flag___1 = 0;
    stackPush(didFuncEntryExecute, & flag___1);
...
#pragma merger("0","./qurt.i","-g,-g")
int a[3] ;
int x1[2] ;
int x2[2] ;
int flag ;
int qurt(void) ;
float qurt_fabs(float qurt_fabs_n )
{
  float qurt_fabs_f ;
  char *symName ;
  void *addr ;
  ...
  {
  if (qurt_fabs_n >= (float )0) {
    qurt_fabs_f = qurt_fabs_n;
    handleAssignmentSymbolically("qurt_fabs_f", "qurt_fabs_n", & qurt_fabs_n, & qurt_fabs_n,
                                 2);
  } else {
    qurt_fabs_f = - qurt_fabs_n;
    handleAssignmentSymbolically("qurt_fabs_f", "(- qurt_fabs_n)", & qurt_fabs_f,
                                 & qurt_fabs_f, 2);
  }
  {
  mapConcolicValues("qurt_fabs_f", & qurt_fabs_f);
  return (qurt_fabs_f);
  }
}
}
void createCDG(void)
{
  ...
  setArray(7, "(! flag___0)");
  addtoCDGnode(12, 2, 0);
  setArray(12, "(< i___0 20)");
  addtoCDGnode(8, 7, 1);
  addtoCDGnode(11, 6, 1);
  addtoCDGnode(9, 7, 1);
  setArray(9, "(<= tmp min_tol)");
  addtoCDGnode(10, 9, 1);
  addtoCDGnode(11, 6, 1);
  addtoCDGnode(11, 6, 1);
  addtoCDGnode(12, 2, 0);
  ...
  setArray(13, "(! flag___0)");
  addtoCDGnode(18, 0, 1);
  addtoCDGnode(14, 13, 1);
  addtoCDGnode(17, 12, 1);
  addtoCDGnode(15, 13, 1);
  setArray(15, "(<= tmp min_tol)");
...
void createSidTable(void)
{
  ...
  {
  add_condition(9, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 0, 0);
  add_condition(7, "(not flag___0)", "flag___0", 0, 0);
  add_condition(6, "(< i___0 20)", "(not (< i___0 20))", 0, 0);
  add_condition(15, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 0, 0);
  add_condition(13, "(not flag___0)", "flag___0", 0, 0);
  add_condition(12, "(< i___0 20)", "(not (< i___0 20))", 0, 0);
  add_condition(2, "(= val 0)", "(not (= val 0))", 0, 0);
}
}
struct arguments {
   int a[3] ;
...
float qurt_sqrt(int global_a[3] , int global_x1[2] , int global_x2[2] , int global_flag ,
                float val )
{
  float x ;
  float dx ;
  ...
  {
  flag = global_flag;
  __cil_tmp12 = malloc(100 * sizeof(char ));
  ...
  printTestCase("qurt_qurt_sqrt_1435946205.tc", __cil_tmp12);
  add_entryToSTable("val", "s4", & val, & val, 2);
  add_entryToSTable("flag", "s3", & flag, & flag, 1);
  x = val / (float )10;
  handleAssignmentSymbolically("x", "(/ val 10)", & x, & x, 2);
  min_tol = (float )0.00001;
  add_entryToSTable("min_tol", "Constant", & min_tol, & min_tol, 2);
  flag___0 = 0;
  add_entryToSTable("flag___0", "Constant", & flag___0, & flag___0, 1);
  {
  exp_outcome = val == (float )0;
  handleAssignmentSymbolically("exp_outcome", "(= val 0)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(2, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(2, 1, 0);
    setTrueExpr(2, "(= val 0)");
    setFalseExpr(2, "(not (= val 0))");
    addToTree(2, 1, "(= val 0)", "(not (= val 0))", 0, 1);
    delete_allVariableTableEntry();
    x = (float )0;
    add_entryToSTable("x", "Constant", & x, & x, 2);
  } else {
    setBranchInfo(2, 0, 1);
    setTrueExpr(2, "(= val 0)");
    setFalseExpr(2, "(not (= val 0))");
    addToTree(2, 1, "(= val 0)", "(not (= val 0))", 0, 0);
    delete_allVariableTableEntry();
    i___0 = 1;
    add_entryToSTable("i___0", "Constant", & i___0, & i___0, 1);
    {
    {
    exp_outcome = i___0 < 20;
    handleAssignmentSymbolically("exp_outcome", "(< i___0 20)", & exp_outcome, & exp_outcome,
                                 1);
    overall_outcome = (int )getConditionalOutcome(6, exp_outcome);
    if (overall_outcome) {
      setBranchInfo(6, 1, 0);
      setTrueExpr(6, "(< i___0 20)");
      setFalseExpr(6, "(not (< i___0 20))");
      addToTree(6, 2, "(< i___0 20)", "(not (< i___0 20))", 2, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = ! flag___0;
      handleAssignmentSymbolically("exp_outcome", "(! flag___0)", & exp_outcome, & exp_outcome,
                                   1);
      overall_outcome = (int )getConditionalOutcome(7, exp_outcome);
      if (overall_outcome) {
        setBranchInfo(7, 1, 0);
        setTrueExpr(7, "(not flag___0)");
        setFalseExpr(7, "flag___0");
        addToTree(7, 3, "(not flag___0)", "flag___0", 6, 1);
        delete_allVariableTableEntry();
        dx = (float )((double )(val - x * x) / (2.0 * (double )x));
        handleAssignmentSymbolically("dx", "(/ (- val (* x x)) (* 2.0 x))", & dx,
                                     & dx, 2);
        x += dx;
        handleAssignmentSymbolically("x", "(+ x dx)", & x, & x, 2);
        diff = val - x * x;
        handleAssignmentSymbolically("diff", "(- val (* x x))", & diff, & diff, 2);
        funcEntry("(float,qurt_fabs_n,variable,diff)", "qurt_fabs_f", "qurt_fabs");
        tmp = qurt_fabs(diff);
        funcExit();
        add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 2);
        {
        exp_outcome = tmp <= min_tol;
        handleAssignmentSymbolically("exp_outcome", "(<= tmp min_tol)", & exp_outcome,
                                     & exp_outcome, 1);
        overall_outcome = (int )getConditionalOutcome(9, exp_outcome);
        if (overall_outcome) {
          setBranchInfo(9, 1, 0);
          setTrueExpr(9, "(<= tmp min_tol)");
          setFalseExpr(9, "(not (<= tmp min_tol))");
          addToTree(9, 4, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 7, 1);
          delete_allVariableTableEntry();
          flag___0 = 1;
          add_entryToSTable("flag___0", "Constant", & flag___0, & flag___0, 1);
        } else {
          ...
          setTrueExpr(9, "(<= tmp min_tol)");
          setFalseExpr(9, "(not (<= tmp min_tol))");
          addToTree(9, 4, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 7, 0);
          delete_allVariableTableEntry();
        }
        }
      } else {
        ...
        setTrueExpr(7, "(not flag___0)");
        setFalseExpr(7, "flag___0");
        addToTree(7, 3, "(not flag___0)", "flag___0", 6, 0);
        delete_allVariableTableEntry();
      }
      }
      i___0 ++;
      ...
      setTrueExpr(6, "(< i___0 20)");
      setFalseExpr(6, "(not (< i___0 20))");
      addToTree(6, 2, "(< i___0 20)", "(not (< i___0 20))", 2, 0);
      delete_allVariableTableEntry();
    }
    }
    {
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(12, "(< i___0 20)");
      setFalseExpr(12, "(not (< i___0 20))");
      addToTree(12, 2, "(< i___0 20)", "(not (< i___0 20))", 2, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = ! flag___0;
      handleAssignmentSymbolically("exp_outcome", "(! flag___0)", & exp_outcome, & exp_outcome,
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(13, "(not flag___0)");
        setFalseExpr(13, "flag___0");
        addToTree(13, 3, "(not flag___0)", "flag___0", 12, 1);
        delete_allVariableTableEntry();
        dx = (float )((double )(val - x * x) / (2.0 * (double )x));
        handleAssignmentSymbolically("dx", "(/ (- val (* x x)) (* 2.0 x))", & dx,
                                     & dx, 2);
        ...
        if (overall_outcome) {
          ...
          setTrueExpr(15, "(<= tmp min_tol)");
          setFalseExpr(15, "(not (<= tmp min_tol))");
          addToTree(15, 4, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 13, 1);
          delete_allVariableTableEntry();
          flag___0 = 1;
          add_entryToSTable("flag___0", "Constant", & flag___0, & flag___0, 1);
        } else {
          ...
          setTrueExpr(15, "(<= tmp min_tol)");
          setFalseExpr(15, "(not (<= tmp min_tol))");
          addToTree(15, 4, "(<= tmp min_tol)", "(not (<= tmp min_tol))", 13, 0);
          delete_allVariableTableEntry();
        }
        }
      } else {
        ...
        setTrueExpr(13, "(not flag___0)");
        setFalseExpr(13, "flag___0");
        addToTree(13, 3, "(not flag___0)", "flag___0", 12, 0);
        delete_allVariableTableEntry();
      }
      }
      i___0 ++;
      ...
      setTrueExpr(12, "(< i___0 20)");
      setFalseExpr(12, "(not (< i___0 20))");
      addToTree(12, 2, "(< i___0 20)", "(not (< i___0 20))", 2, 0);
      delete_allVariableTableEntry();
    }
    }
    }
  ...
  __cil_tmp11 = isNotQueueEmpty();
  if (__cil_tmp11) {
    enQueue();
    directPathConditions();
    delete_allSTableEntry();
    delete_allStructTableEntry();
    qurt_sqrt(a, x1, x2, flag, val);
  } else {
    __cil_tmp11 = startCDG();
    add_entryToSTable("__cil_tmp11", "Function", & __cil_tmp11, & __cil_tmp11, 1);
    if (__cil_tmp11) {
      __cil_tmp11 = getTestCases();
      qurt_sqrt(a, x1, x2, flag, val);
    }
  }
  return (x);
...
int qurt(void)
{
  ...
  if ((double )a[0] == 0.0) {
    {
    qurt___cil_tmp5 = 999;
    add_entryToSTable("qurt___cil_tmp5", "Constant", & qurt___cil_tmp5, & qurt___cil_tmp5,
                      1);
    {
    mapConcolicValues("qurt___cil_tmp5", & qurt___cil_tmp5);
    return (qurt___cil_tmp5);
    }
    }
  }
  qurt_d = (float )(a[1] * a[1] - (4 * a[0]) * a[2]);
  handleAssignmentSymbolically("qurt_d", "(- (* a[1] a[1]) (* (* 4 a[0]) a[2]))",
                               & qurt_d, & qurt_d, 2);
  qurt_w1 = (float )(2.0 * (double )a[0]);
  handleAssignmentSymbolically("qurt_w1", "(* 2.0 a[0])", & qurt_w1, & qurt_w1, 2);
  funcEntry("(float,qurt_fabs_n,variable,qurt_d)", "qurt_fabs_f", "qurt_fabs");
  qurt_tmp = qurt_fabs(qurt_d);
  funcExit();
  add_entryToSTable("qurt_tmp", ret_SymValue, ret_ConValue, & qurt_tmp, 2);
  if ((double )qurt_d > 0.0) {
    flag = 1;
    add_entryToSTable("flag", "Constant", & flag, & flag, 1);
    x1[0] = (int )(((float )(- a[1]) + qurt_w2) / qurt_w1);
    handleArraySymbolically("x1", 0, "(int )(((float )(- a[1]) + qurt_w2) / qurt_w1)",
                            & x1[0], & x1[0], 1);
    x1[1] = (int )0.0;
    handleArraySymbolically("x1", 1, "(int )0.0", & x1[1], & x1[1], 1);
    x2[0] = (int )(((float )(- a[1]) - qurt_w2) / qurt_w1);
    handleArraySymbolically("x2", 0, "(int )(((float )(- a[1]) - qurt_w2) / qurt_w1)",
                            & x2[0], & x2[0], 1);
    x2[1] = (int )0.0;
    handleArraySymbolically("x2", 1, "(int )0.0", & x2[1], & x2[1], 1);
    {
    qurt___cil_tmp6 = 0;
    add_entryToSTable("qurt___cil_tmp6", "Constant", & qurt___cil_tmp6, & qurt___cil_tmp6,
                      1);
    {
    mapConcolicValues("qurt___cil_tmp6", & qurt___cil_tmp6);
    return (qurt___cil_tmp6);
    }
    }
  } else
  if ((double )qurt_d == 0.0) {
    flag = 0;
    add_entryToSTable("flag", "Constant", & flag, & flag, 1);
    x1[0] = (int )((float )(- a[1]) / qurt_w1);
    handleArraySymbolically("x1", 0, "(int )((float )(- a[1]) / qurt_w1)", & x1[0],
                            & x1[0], 1);
    x1[1] = (int )0.0;
    handleArraySymbolically("x1", 1, "(int )0.0", & x1[1], & x1[1], 1);
    x2[0] = x1[0];
    addEntryToVariableTable("x1[0]", 0);
    add_entryToArraySTable("x1", 0, "x120", & x1[0], & x1[0], 1);
    handleArraySymbolically("x2", 0, "x1[0]", & x2[0], & x2[0], 1);
    x2[1] = (int )0.0;
    handleArraySymbolically("x2", 1, "(int )0.0", & x2[1], & x2[1], 1);
    {
    qurt___cil_tmp7 = 0;
    add_entryToSTable("qurt___cil_tmp7", "Constant", & qurt___cil_tmp7, & qurt___cil_tmp7,
                      1);
    {
    mapConcolicValues("qurt___cil_tmp7", & qurt___cil_tmp7);
    return (qurt___cil_tmp7);
    }
    }
  } else {
    flag = -1;
    add_entryToSTable("flag", "Constant", & flag, & flag, 1);
    qurt_w2 /= qurt_w1;
    handleAssignmentSymbolically("qurt_w2", "(/ qurt_w2 qurt_w1)", & qurt_w2, & qurt_w2,
                                 2);
    x1[0] = (int )((float )(- a[1]) / qurt_w1);
    handleArraySymbolically("x1", 0, "(int )((float )(- a[1]) / qurt_w1)", & x1[0],
                            & x1[0], 1);
    x1[1] = (int )qurt_w2;
    handleArraySymbolically("x1", 1, "(int )qurt_w2", & x1[1], & x1[1], 1);
    x2[0] = x1[0];
    addEntryToVariableTable("x1[0]", 0);
    add_entryToArraySTable("x1", 0, "x121", & x1[0], & x1[0], 1);
    handleArraySymbolically("x2", 0, "x1[0]", & x2[0], & x2[0], 1);
    x2[1] = (int )(- qurt_w2);
    handleArraySymbolically("x2", 1, "(int )(- qurt_w2)", & x2[1], & x2[1], 1);
    {
    qurt___cil_tmp8 = 0;
    add_entryToSTable("qurt___cil_tmp8", "Constant", & qurt___cil_tmp8, & qurt___cil_tmp8,
                      1);
    {
    mapConcolicValues("qurt___cil_tmp8", & qurt___cil_tmp8);
    return (qurt___cil_tmp8);
    }
    }
  }
}
...
void callInstrumentedFun(void)
{
  ...
  {
  enQueue();
  qurt_sqrt(argvar.a, argvar.x1, argvar.x2, argvar.flag, argvar.val);
}
}
void main(void)
{
  ...
  while (1) {
    if (__cil_tmp9 >= 3) {
      ...
      __cil_tmp8 = rand();
      argvar.a[__cil_tmp9] = __cil_tmp8 % 20;
      __cil_tmp9 ++;
    }
  }
  __cil_tmp7 = 0;
  while (1) {
    if (__cil_tmp7 >= 2) {
      ...
      __cil_tmp6 = rand();
      argvar.x1[__cil_tmp7] = __cil_tmp6 % 20;
      __cil_tmp7 ++;
    }
  }
  __cil_tmp5 = 0;
  while (1) {
    if (__cil_tmp5 >= 2) {
      ...
      __cil_tmp4 = rand();
      argvar.x2[__cil_tmp5] = __cil_tmp4 % 20;
      __cil_tmp5 ++;
    }
  }
  __cil_tmp3 = rand();
  argvar.flag = __cil_tmp3 % 20;
  __cil_tmp2 = rand();
  argvar.val = __cil_tmp2 % 20;
  initSID();
  isCopyOfHolder();
  createCDG();
  createSidTable();
