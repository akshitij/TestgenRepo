...
#pragma merger("0","./corlan.i","-g,-g")
extern int scanf(char const * __restrict __format , ...) __asm__("__isoc99_scanf") ;
float dopoly(float dopoly_x )
{
  float dopoly_mu ;
  float dopoly_s ;
  int dopoly_j ;
  float dopoly_pol[100] ;
  char *symName ;
  void *addr ;
  char in[15] ;

  {
  dopoly_mu = (float )10.0;
  add_entryToSTable("dopoly_mu", "Constant", & dopoly_mu, & dopoly_mu, 2);
  dopoly_j = 0;
  add_entryToSTable("dopoly_j", "Constant", & dopoly_j, & dopoly_j, 1);
  {
  if (dopoly_j < 100) {
    dopoly_mu = (float )(((double )dopoly_mu + 2.0) / 2.0);
    handleAssignmentSymbolically("dopoly_mu", "(/ (+ dopoly_mu 2.0) 2.0)", & dopoly_mu,
                                 & dopoly_mu, 2);
    dopoly_pol[dopoly_j] = dopoly_mu;
    handleArraySymbolically("dopoly_pol", dopoly_j, "dopoly_mu", & dopoly_pol[dopoly_j],
                            & dopoly_pol[dopoly_j], 2);
    dopoly_j ++;
    handleAssignmentSymbolically("dopoly_j", "(+ dopoly_j 1)", & dopoly_j, & dopoly_j,
                                 1);
  }
  if (dopoly_j < 100) {
    dopoly_mu = (float )(((double )dopoly_mu + 2.0) / 2.0);
  ...
  dopoly_s = (float )0.0;
  add_entryToSTable("dopoly_s", "Constant", & dopoly_s, & dopoly_s, 2);
  dopoly_j = 0;
  add_entryToSTable("dopoly_j", "Constant", & dopoly_j, & dopoly_j, 1);
  {
  if (dopoly_j < 100) {
    dopoly_s = dopoly_x * dopoly_s + dopoly_pol[dopoly_j];
    addEntryToVariableTable("dopoly_pol[dopoly_j]", dopoly_j);
    add_entryToArraySTable("dopoly_pol", dopoly_j, "dopoly_pol20", & dopoly_pol[dopoly_j],
                           & dopoly_pol[dopoly_j], 1);
    handleAssignmentSymbolically("dopoly_s", "(+ (* dopoly_x dopoly_s) dopoly_pol[dopoly_j])",
                                 & dopoly_s, & dopoly_s, 2);
    dopoly_j ++;
    handleAssignmentSymbolically("dopoly_j", "(+ dopoly_j 1)", & dopoly_j, & dopoly_j,
                                 1);
  ...
  if (dopoly_j < 100) {
    dopoly_s = dopoly_x * dopoly_s + dopoly_pol[dopoly_j];
    addEntryToVariableTable("dopoly_pol[dopoly_j]", dopoly_j);
    add_entryToArraySTable("dopoly_pol", dopoly_j, "dopoly_pol21", & dopoly_pol[dopoly_j],
                           & dopoly_pol[dopoly_j], 1);
    handleAssignmentSymbolically("dopoly_s", "(+ (* dopoly_x dopoly_s) dopoly_pol[dopoly_j])",
                                 & dopoly_s, & dopoly_s, 2);
    dopoly_j ++;
  ...
  {
  mapConcolicValues("dopoly_s", & dopoly_s);
  return (dopoly_s);
  }
}
}
...
int main1(int n , float x )
{
  ...
  pu = (float )0.0;
  add_entryToSTable("pu", "Constant", & pu, & pu, 2);
  i___0 = 0;
  ...
  if (overall_outcome) {
    ...
    delete_allVariableTableEntry();
    funcEntry("(float,dopoly_x,variable,x)", "dopoly_mu dopoly_s dopoly_j dopoly_pol",
              "dopoly");
    tmp = dopoly(x);
    funcExit();
    add_entryToSTable("tmp", ret_SymValue, ret_ConValue, & tmp, 2);
    pu += tmp;
    handleAssignmentSymbolically("pu", "(+ pu tmp)", & pu, & pu, 2);
    i___0 ++;
