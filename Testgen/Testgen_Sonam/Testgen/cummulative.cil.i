...
#pragma merger("0","./cummulative.i","-g,-g")
extern int scanf(char const * __restrict __format , ...) __asm__("__isoc99_scanf") ;
int cummulative(int cummulative_x )
{
  int cummulative_tmp ;
  int cummulative___cil_tmp3 ;
  int cummulative___cil_tmp4 ;
  int cummulative___cil_tmp5 ;
  char *symName ;
  void *addr ;
  char in[15] ;
  ...
  if (cummulative_x <= 0) {
    {
    cummulative___cil_tmp3 = 0;
    add_entryToSTable("cummulative___cil_tmp3", "Constant", & cummulative___cil_tmp3,
                      & cummulative___cil_tmp3, 1);
    {
    mapConcolicValues("cummulative___cil_tmp3", & cummulative___cil_tmp3);
    return (cummulative___cil_tmp3);
    }
    }
  } else {
    cummulative___cil_tmp5 = cummulative_x - 1;
    handleAssignmentSymbolically("cummulative___cil_tmp5", "(- cummulative_x 1)",
                                 & cummulative___cil_tmp5, & cummulative___cil_tmp5,
                                 1);
    funcEntry("(int,cummulative_x,variable,cummulative___cil_tmp5)", "cummulative_tmp cummulative___cil_tmp3 cummulative___cil_tmp4 cummulative___cil_tmp5",
              "cummulative");
    cummulative_tmp = cummulative(cummulative___cil_tmp5);
    funcExit();
    add_entryToSTable("cummulative_tmp", ret_SymValue, ret_ConValue, & cummulative_tmp,
                      1);
    {
    cummulative___cil_tmp4 = cummulative_x + cummulative_tmp;
    handleAssignmentSymbolically("cummulative___cil_tmp4", "(+ cummulative_x cummulative_tmp)",
                                 & cummulative___cil_tmp4, & cummulative___cil_tmp4,
                                 1);
    {
    mapConcolicValues("cummulative___cil_tmp4", & cummulative___cil_tmp4);
    return (cummulative___cil_tmp4);
    }
    }
  }
}
...
void createSidTable(void)
{
  ...
  {
  add_condition(10, "(< a 25)", "(not (< a 25))", 0, 0);
}
}
struct arguments {
   int a ;
...
int main1(int a )
{
  ...
  printTestCase("cummulative_main1_1434118525.tc", __cil_tmp7);
  add_entryToSTable("a", "s0", & a, & a, 1);
  funcEntry("(int,cummulative_x,variable,a)", "cummulative_tmp cummulative___cil_tmp3 cummulative___cil_tmp4 cummulative___cil_tmp5",
            "cummulative");
  a = cummulative(a);
  funcExit();
  ...
  {
  exp_outcome = a < 25;
  handleAssignmentSymbolically("exp_outcome", "(< a 25)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(10, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(10, 1, 0);
    setTrueExpr(10, "(< a 25)");
    setFalseExpr(10, "(not (< a 25))");
    addToTree(10, 1, "(< a 25)", "(not (< a 25))", 0, 1);
    delete_allVariableTableEntry();
    c = 1;
    ...
    setTrueExpr(10, "(< a 25)");
    setFalseExpr(10, "(not (< a 25))");
    addToTree(10, 1, "(< a 25)", "(not (< a 25))", 0, 0);
    delete_allVariableTableEntry();
    c = -1;
    add_entryToSTable("c", "Constant", & c, & c, 1);
  }
