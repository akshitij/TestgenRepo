 $(OBJDIR)/main.cmo $(OBJDIR)/:   $(OBJDIR)/vartype.cmo   $(OBJDIR)/varUpdated.cmo  $(OBJDIR)/util.cmi \
     $(OBJDIR)/testcil.cmo   $(OBJDIR)/test.cmo   $(OBJDIR)/sym.cmo  $(OBJDIR)/stats.cmi \
      $(OBJDIR)/simplify.cmi   $(OBJDIR)/simplemem.cmo   $(OBJDIR)/sidTable.cmo \
 ...
 $(OBJDIR)/main.cmx $(OBJDIR)/:   $(OBJDIR)/vartype.cmx   $(OBJDIR)/varUpdated.cmx  $(OBJDIR)/util.cmx \
     $(OBJDIR)/testcil.cmx   $(OBJDIR)/test.cmx   $(OBJDIR)/sym.cmx  $(OBJDIR)/stats.cmx \
      $(OBJDIR)/simplify.cmx   $(OBJDIR)/simplemem.cmx   $(OBJDIR)/sidTable.cmx \
