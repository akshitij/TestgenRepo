...
#pragma merger("0","./factorialRec.i","-g,-g")
...
int fact(int fact_x )
{
  ...
  if (fact_x <= 1) {
    ...
    add_entryToSTable("fact___cil_tmp3", "Constant", & fact___cil_tmp3, & fact___cil_tmp3,
                      1);
    {
    mapConcolicValues("fact___cil_tmp3", & fact___cil_tmp3);
    ...
    handleAssignmentSymbolically("fact___cil_tmp5", "(- fact_x 1)", & fact___cil_tmp5,
                                 & fact___cil_tmp5, 1);
    funcEntry("(int,fact_x,variable,fact___cil_tmp5)", "fact_tmp fact___cil_tmp3 fact___cil_tmp4 fact___cil_tmp5",
              "fact");
    ...
    handleAssignmentSymbolically("fact___cil_tmp4", "(* fact_x fact_tmp)", & fact___cil_tmp4,
                                 & fact___cil_tmp4, 1);
    {
    mapConcolicValues("fact___cil_tmp4", & fact___cil_tmp4);
...
void createSidTable(void)
{
  ...
  {
  add_condition(10, "(= a 120)", "(not (= a 120))", 0, 0);
}
}
struct arguments {
   int a ;
...
int main1(int a )
{
  ...
  printTestCase("factorialRec_main1_1434102191.tc", __cil_tmp7);
  add_entryToSTable("a", "s0", & a, & a, 1);
  funcEntry("(int,fact_x,variable,a)", "fact_tmp fact___cil_tmp3 fact___cil_tmp4 fact___cil_tmp5",
            "fact");
  a = fact(a);
  funcExit();
  ...
  {
  exp_outcome = a == 120;
  handleAssignmentSymbolically("exp_outcome", "(= a 120)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(10, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(10, 1, 0);
    setTrueExpr(10, "(= a 120)");
    setFalseExpr(10, "(not (= a 120))");
    addToTree(10, 1, "(= a 120)", "(not (= a 120))", 0, 1);
    delete_allVariableTableEntry();
    c = 1;
    ...
    setTrueExpr(10, "(= a 120)");
    setFalseExpr(10, "(not (= a 120))");
    addToTree(10, 1, "(= a 120)", "(not (= a 120))", 0, 0);
    delete_allVariableTableEntry();
    c = -1;
    add_entryToSTable("c", "Constant", & c, & c, 1);
  }
