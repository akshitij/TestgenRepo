...
{ 
  ...
  {
  add_condition(4, "(= a 6.6)", "(not (= a 6.6))", 0, 0);
}
}
struct arguments {
   float a ;
...
{ 
  ...
  printTestCase("tripleFloatFunc_main1_1434924554.tc", __cil_tmp7);
  ...
  {
  exp_outcome = (double )a == 6.6;
  handleAssignmentSymbolically("exp_outcome", "(= a 6.6)", & exp_outcome, & exp_outcome,
                               1);
  overall_outcome = (int )getConditionalOutcome(4, exp_outcome);
  if (overall_outcome) {
    setBranchInfo(4, 1, 0);
    setTrueExpr(4, "(= a 6.6)");
    setFalseExpr(4, "(not (= a 6.6))");
    addToTree(4, 1, "(= a 6.6)", "(not (= a 6.6))", 0, 1);
    delete_allVariableTableEntry();
    b = (float )1.1;
    ...
    setTrueExpr(4, "(= a 6.6)");
    setFalseExpr(4, "(not (= a 6.6))");
    addToTree(4, 1, "(= a 6.6)", "(not (= a 6.6))", 0, 0);
    delete_allVariableTableEntry();
    b = (float )(- 1.1);
