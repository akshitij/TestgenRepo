# 1 "src/src/loopUnrollTest.cil.c"
...
#pragma merger("0","src/src/loopUnrollTest.i","-g,-g")
...
void createSidTable(void)
{
  ...
  {
  add_condition(3, "(< a 3)", "(not (< a 3))", 0, 0);
  add_condition(5, "(< a 3)", "(not (< a 3))", 0, 0);
  add_condition(7, "(>= a 0)", "(not (>= a 0))", 0, 0);
}
}
struct arguments {
   int a ;
...
int main1(int a )
{
  ...
  printTestCase("loopUnrollTest_main1_1433002660.tc", __cil_tmp6);
  ...
  if (overall_outcome) {
    setBranchInfo(3, 1, 0);
    setTrueExpr(3, "(< a 3)");
    setFalseExpr(3, "(not (< a 3))");
    addToTree(3, 1, "(< a 3)", "(not (< a 3))", 0, 1);
    delete_allVariableTableEntry();
    b += 2;
    handleAssignmentSymbolically("b", "(+ b 2)", & b, & b, 1);
    a ++;
  ...
  if (overall_outcome) {
    setBranchInfo(5, 1, 0);
    setTrueExpr(5, "(< a 3)");
    setFalseExpr(5, "(not (< a 3))");
    addToTree(5, 1, "(< a 3)", "(not (< a 3))", 0, 1);
    delete_allVariableTableEntry();
    b += 2;
    handleAssignmentSymbolically("b", "(+ b 2)", & b, & b, 1);
    a ++;
  ...
  if (overall_outcome) {
    setBranchInfo(7, 1, 0);
    setTrueExpr(7, "(>= a 0)");
    setFalseExpr(7, "(not (>= a 0))");
    addToTree(7, 1, "(>= a 0)", "(not (>= a 0))", 0, 1);
    delete_allVariableTableEntry();
    b = 1;
