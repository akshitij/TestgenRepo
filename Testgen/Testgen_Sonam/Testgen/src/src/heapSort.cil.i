...
#pragma merger("0","src/src/heapSort.i","-g,-g")
...
void createSidTable(void)
{
  ...
  {
  add_condition(7, "(> item *(a + j))", "(not (> item *(a + j)))", 0, 0);
  add_condition(6, "(> i 0)", "(not (> i 0))", 0, 0);
  add_condition(10, "(> item *(a + j))", "(not (> item *(a + j)))", 0, 0);
  add_condition(9, "(> i 0)", "(not (> i 0))", 0, 0);
  add_condition(3, "(< k n)", "(not (< k n))", 0, 0);
  add_condition(17, "(> item *(a + j))", "(not (> item *(a + j)))", 0, 0);
  add_condition(16, "(> i 0)", "(not (> i 0))", 0, 0);
  add_condition(20, "(> item *(a + j))", "(not (> item *(a + j)))", 0, 0);
  add_condition(19, "(> i 0)", "(not (> i 0))", 0, 0);
  add_condition(13, "(< k n)", "(not (< k n))", 0, 0);
}
}
struct arguments {
   int *a ;
...
void heapify(int *a , int n )
{
  ...
  sprintf(__cil_tmp10, "\t%d\t%d\t%d\t%d\t%d\t%d\n", a[0], a[1], a[2], a[3], a[4],
          n);
  printTestCase("heapSort_heapify_1432550413.tc", __cil_tmp10);
  ...
  if (overall_outcome) {
    setBranchInfo(3, 1, 0);
    setTrueExpr(3, "(< k n)");
    setFalseExpr(3, "(not (< k n))");
    addToTree(3, 1, "(< k n)", "(not (< k n))", 0, 1);
    delete_allVariableTableEntry();
    item = *(a + k);
    addEntryToVariableTable("*(a + k)", k);
    add_entryToArraySTable("a", k, "a10", a + k, a + k, 1);
    handleAssignmentSymbolically("item", "*(a + k)", & *(a + k), & *(a + k), 1);
    i = k;
    handleAssignmentSymbolically("i", "k", & k, & k, 1);
    j = (i - 1) / 2;
    handleAssignmentSymbolically("j", "(/ (- i 1) 2)", & j, & j, 1);
    {
    {
    exp_outcome = i > 0;
    handleAssignmentSymbolically("exp_outcome", "(> i 0)", & exp_outcome, & exp_outcome,
                                 1);
    overall_outcome = (int )getConditionalOutcome(6, exp_outcome);
    if (overall_outcome) {
      setBranchInfo(6, 1, 0);
      setTrueExpr(6, "(> i 0)");
      setFalseExpr(6, "(not (> i 0))");
      addToTree(6, 2, "(> i 0)", "(not (> i 0))", 3, 1);
      delete_allVariableTableEntry();
      {
      ...
      if (overall_outcome) {
        ...
        setBranchInfo(7, 1, 0);
        setTrueExpr(7, "(> item *(a + j))");
        setFalseExpr(7, "(not (> item *(a + j)))");
        addToTree(7, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 6, 1);
        delete_allVariableTableEntry();
        *(a + i) = *(a + j);
        addEntryToVariableTable("*(a + j)", j);
        add_entryToArraySTable("a", j, "a12", a + j, a + j, 1);
        handleArraySymbolically("a", i, "*(a + j)", a + i, a + i, 1);
        i = j;
        handleAssignmentSymbolically("i", "j", & j, & j, 1);
        j = (i - 1) / 2;
        handleAssignmentSymbolically("j", "(/ (- i 1) 2)", & j, & j, 1);
      } else {
        addEntryToVariableTable("*(a + j)", j);
        ...
        setTrueExpr(7, "(> item *(a + j))");
        setFalseExpr(7, "(not (> item *(a + j)))");
        addToTree(7, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 6, 0);
        delete_allVariableTableEntry();
      }
      }
    } else {
    ...
    if (overall_outcome) {
      setBranchInfo(9, 1, 0);
      setTrueExpr(9, "(> i 0)");
      setFalseExpr(9, "(not (> i 0))");
      addToTree(9, 2, "(> i 0)", "(not (> i 0))", 3, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = item > *(a + j);
      addEntryToVariableTable("*(a + j)", j);
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(10, "(> item *(a + j))");
        setFalseExpr(10, "(not (> item *(a + j)))");
        addToTree(10, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 9, 1);
        delete_allVariableTableEntry();
        *(a + i) = *(a + j);
        addEntryToVariableTable("*(a + j)", j);
        add_entryToArraySTable("a", j, "a14", a + j, a + j, 1);
        handleArraySymbolically("a", i, "*(a + j)", a + i, a + i, 1);
        i = j;
        handleAssignmentSymbolically("i", "j", & j, & j, 1);
        j = (i - 1) / 2;
        ...
        setTrueExpr(10, "(> item *(a + j))");
        setFalseExpr(10, "(not (> item *(a + j)))");
        addToTree(10, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 9, 0);
        delete_allVariableTableEntry();
      }
      }
    } else {
      ...
      setTrueExpr(9, "(> i 0)");
      setFalseExpr(9, "(not (> i 0))");
      addToTree(9, 2, "(> i 0)", "(not (> i 0))", 3, 0);
      delete_allVariableTableEntry();
    }
    }
    }
    *(a + i) = item;
    handleArraySymbolically("a", i, "item", a + i, a + i, 1);
    k ++;
  ...
  if (overall_outcome) {
    ...
    setTrueExpr(13, "(< k n)");
    setFalseExpr(13, "(not (< k n))");
    addToTree(13, 1, "(< k n)", "(not (< k n))", 0, 1);
    delete_allVariableTableEntry();
    item = *(a + k);
    addEntryToVariableTable("*(a + k)", k);
    add_entryToArraySTable("a", k, "a15", a + k, a + k, 1);
    handleAssignmentSymbolically("item", "*(a + k)", & *(a + k), & *(a + k), 1);
    i = k;
    handleAssignmentSymbolically("i", "k", & k, & k, 1);
    j = (i - 1) / 2;
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(16, "(> i 0)");
      setFalseExpr(16, "(not (> i 0))");
      addToTree(16, 2, "(> i 0)", "(not (> i 0))", 13, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = item > *(a + j);
      addEntryToVariableTable("*(a + j)", j);
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(17, "(> item *(a + j))");
        setFalseExpr(17, "(not (> item *(a + j)))");
        addToTree(17, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 16, 1);
        delete_allVariableTableEntry();
        *(a + i) = *(a + j);
        addEntryToVariableTable("*(a + j)", j);
        ...
        setTrueExpr(17, "(> item *(a + j))");
        setFalseExpr(17, "(not (> item *(a + j)))");
        addToTree(17, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 16, 0);
        delete_allVariableTableEntry();
      }
      }
    } else {
      ...
      setTrueExpr(16, "(> i 0)");
      setFalseExpr(16, "(not (> i 0))");
      addToTree(16, 2, "(> i 0)", "(not (> i 0))", 13, 0);
      delete_allVariableTableEntry();
    }
    }
    {
    ...
    if (overall_outcome) {
      ...
      setTrueExpr(19, "(> i 0)");
      setFalseExpr(19, "(not (> i 0))");
      addToTree(19, 2, "(> i 0)", "(not (> i 0))", 13, 1);
      delete_allVariableTableEntry();
      {
      exp_outcome = item > *(a + j);
      addEntryToVariableTable("*(a + j)", j);
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(20, "(> item *(a + j))");
        setFalseExpr(20, "(not (> item *(a + j)))");
        addToTree(20, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 19, 1);
        delete_allVariableTableEntry();
        *(a + i) = *(a + j);
        addEntryToVariableTable("*(a + j)", j);
        add_entryToArraySTable("a", j, "a19", a + j, a + j, 1);
        handleArraySymbolically("a", i, "*(a + j)", a + i, a + i, 1);
        i = j;
        handleAssignmentSymbolically("i", "j", & j, & j, 1);
        j = (i - 1) / 2;
        ...
        setTrueExpr(20, "(> item *(a + j))");
        setFalseExpr(20, "(not (> item *(a + j)))");
        addToTree(20, 3, "(> item *(a + j))", "(not (> item *(a + j)))", 19, 0);
        delete_allVariableTableEntry();
      }
      }
    } else {
      ...
      setTrueExpr(19, "(> i 0)");
      setFalseExpr(19, "(not (> i 0))");
      addToTree(19, 2, "(> i 0)", "(not (> i 0))", 13, 0);
      delete_allVariableTableEntry();
    }
    }
    }
    *(a + i) = item;
    ...
    setTrueExpr(13, "(< k n)");
    setFalseExpr(13, "(not (< k n))");
    addToTree(13, 1, "(< k n)", "(not (< k n))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
