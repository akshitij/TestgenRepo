...
#pragma merger("0","src/src/quicksort.i","-g,-g")
void createCDG(void)
{
...
void swap(int *a , int *b )
{
  ...
  sprintf(__cil_tmp7, "\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n", a[0], a[1], a[2],
          a[3], a[4], b[0], b[1], b[2], b[3], b[4]);
  printTestCase("quicksort_swap_1432550352.tc", __cil_tmp7);
  add_entryToArraySTable("b", 0, "b_0", b, b, 1);
  add_entryToArraySTable("a", 0, "a_0", a, a, 1);
  t = *a;
  addEntryToVariableTable("*a", 1);
  handleAssignmentSymbolically("t", "*a", & *a, & *a, 1);
  *a = *b;
  addEntryToVariableTable("*b", 1);
  handleArraySymbolically("a", 0, "*b", a, a, 1);
  *b = t;
  handleArraySymbolically("b", 0, "t", b, b, 1);
