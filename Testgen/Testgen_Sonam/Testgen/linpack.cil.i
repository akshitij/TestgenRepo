...
int ddot_r(int *global_mempool , int n , int *dx , int icx , int *dy , int icy ) ;
...
int idamax(int idamax_n , int *idamax_dx , int idamax_icx ) ;
int *mempool ;
void matgen(int *matgen_a , int matgen_lda , int matgen_n , int *matgen_b , int *matgen_norma )
{
  int matgen_init ;
    ...
    if (dgefa_nm1 >= 0) {
      ...
      if (dgefa_k < dgefa_nm1) {
        ...
        add_entryToSTable("dgefa___cil_tmp17", "Constant", & dgefa___cil_tmp17, & dgefa___cil_tmp17,
                          1);
        funcEntry("(int,idamax_n,variable,dgefa___cil_tmp15)#(int *,idamax_dx,array,dgefa___cil_tmp16)#(int,idamax_icx,variable,dgefa___cil_tmp17)",
        ...
        *(dgefa_ipvt + dgefa_k) = dgefa_l;
        ...
        if (! (*(dgefa_a + (dgefa_lda * dgefa_k + dgefa_l)) == 0)) {
          ...
          add_entryToSTable("dgefa___cil_tmp20", "Constant", & dgefa___cil_tmp20,
                            & dgefa___cil_tmp20, 1);
          funcEntry("(int,dscal_r_n,variable,dgefa___cil_tmp18)#(int,dscal_r_da,variable,dgefa_t)#(int *,dscal_r_dx,array,dgefa___cil_tmp19)#(int,dscal_r_ic,variable,dgefa___cil_tmp20)",
      ...
      if (dgesl_nm1 >= 1) {
        ...
        if (dgesl_k < dgesl_nm1) {
          ...
          add_entryToSTable("dgesl___cil_tmp19", "Constant", & dgesl___cil_tmp19,
                            & dgesl___cil_tmp19, 1);
          funcEntry("(int,daxpy_r_n,variable,dgesl___cil_tmp15)#(int,daxpy_r_da,variable,dgesl_t)#(int *,daxpy_r_dx,array,dgesl___cil_tmp16)#(int,daxpy_r_icx,variable,dgesl___cil_tmp17)#(int *,daxpy_r_dy,array,dgesl___cil_tmp18)#(int,daxpy_r_icy,variable,dgesl___cil_tmp19)",
                    "daxpy_r_i___0 daxpy_r_ix daxpy_r_iy", "daxpy_r");
      ...
      if (dgesl_kb < dgesl_n) {
        ...
        *(dgesl_b + dgesl_k) /= *(dgesl_a + (dgesl_lda * dgesl_k + dgesl_k));
        ...
        add_entryToSTable("dgesl___cil_tmp23", "Constant", & dgesl___cil_tmp23, & dgesl___cil_tmp23,
                          1);
        funcEntry("(int,daxpy_r_n,variable,dgesl_k)#(int,daxpy_r_da,variable,dgesl_t)#(int *,daxpy_r_dx,array,dgesl___cil_tmp20)#(int,daxpy_r_icx,variable,dgesl___cil_tmp21)#(int *,daxpy_r_dy,array,dgesl___cil_tmp22)#(int,daxpy_r_icy,variable,dgesl___cil_tmp23)",
                  "daxpy_r_i___0 daxpy_r_ix daxpy_r_iy", "daxpy_r");
...
void createSidTable(void)
{
  ...
  {
  add_condition(2, "(<= n 0)", "(not (<= n 0))", 0, 0);
  add_condition(10, "(< icx 0)", "(not (< icx 0))", 0, 0);
  add_condition(12, "(< icy 0)", "(not (< icy 0))", 0, 0);
  add_condition(16, "(< i___0 n)", "(not (< i___0 n))", 0, 0);
  add_condition(18, "(< i___0 n)", "(not (< i___0 n))", 0, 0);
  add_condition(8, "(! (= icy 1))", "(not (! (= icy 1)))", 0, 0);
  add_condition(6, "(! (= icx 1))", "(not (! (= icx 1)))", 0, 0);
  add_condition(23, "(< i___0 n)", "(not (< i___0 n))", 0, 0);
  add_condition(25, "(< i___0 n)", "(not (< i___0 n))", 0, 0);
}
}
struct arguments {
   int *mempool ;
...
int ddot_r(int *global_mempool , int n , int *dx , int icx , int *dy , int icy )
{
  ...
  sprintf(__cil_tmp14, "\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
          mempool[0], mempool[1], mempool[2], mempool[3], mempool[4], n, dx[0], dx[1],
          dx[2], dx[3], dx[4], icx, dy[0], dy[1], dy[2], dy[3], dy[4], icy);
  printTestCase("linpack_ddot_r_1436250637.tc", __cil_tmp14);
  add_entryToSTable("icy", "s5", & icy, & icy, 1);
  ...
  dtemp = 0;
  add_entryToSTable("dtemp", "Constant", & dtemp, & dtemp, 1);
  {
  exp_outcome = n <= 0;
  ...
  if (overall_outcome) {
    setBranchInfo(2, 1, 0);
    setTrueExpr(2, "(<= n 0)");
    setFalseExpr(2, "(not (<= n 0))");
    addToTree(2, 1, "(<= n 0)", "(not (<= n 0))", 0, 1);
    delete_allVariableTableEntry();
    {
    __cil_tmp10 = 0;
    add_entryToSTable("__cil_tmp10", "Constant", & __cil_tmp10, & __cil_tmp10, 1);
    ...
    if (__cil_tmp13) {
      ...
      delete_allSTableEntry();
      delete_allStructTableEntry();
      ddot_r(mempool, n, dx, icx, dy, icy);
    } else {
  ...
  if (overall_outcome) {
    setBranchInfo(6, 1, 0);
    setTrueExpr(6, "(not (= icx 1))");
    setFalseExpr(6, "(not (not (= icx 1)))");
    addToTree(6, 1, "(not (= icx 1))", "(not (not (= icx 1)))", 0, 1);
    delete_allVariableTableEntry();
    goto _L;
  } else {
    setBranchInfo(6, 0, 1);
    setTrueExpr(6, "(not (= icx 1))");
    setFalseExpr(6, "(not (not (= icx 1)))");
    addToTree(6, 1, "(not (= icx 1))", "(not (not (= icx 1)))", 0, 0);
    delete_allVariableTableEntry();
    {
    exp_outcome = icy != 1;
    ...
    if (overall_outcome) {
      setBranchInfo(8, 1, 0);
      setTrueExpr(8, "(not (= icy 1))");
      setFalseExpr(8, "(not (not (= icy 1)))");
      addToTree(8, 2, "(not (= icy 1))", "(not (not (= icy 1)))", 6, 1);
      delete_allVariableTableEntry();
      _L:
      ix = 0;
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(10, "(< icx 0)");
        setFalseExpr(10, "(not (< icx 0))");
        addToTree(10, 3, "(< icx 0)", "(not (< icx 0))", 8, 1);
        delete_allVariableTableEntry();
        ix = (- n + 1) * icx;
        handleAssignmentSymbolically("ix", "(* (+ (- n) 1) icx)", & ix, & ix, 1);
      } else {
        setBranchInfo(10, 0, 1);
        setTrueExpr(10, "(< icx 0)");
        setFalseExpr(10, "(not (< icx 0))");
        addToTree(10, 3, "(< icx 0)", "(not (< icx 0))", 8, 0);
        delete_allVariableTableEntry();
      }
      }
      {
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(12, "(< icy 0)");
        setFalseExpr(12, "(not (< icy 0))");
        addToTree(12, 3, "(< icy 0)", "(not (< icy 0))", 8, 1);
        delete_allVariableTableEntry();
        iy = (- n + 1) * icy;
        handleAssignmentSymbolically("iy", "(* (+ (- n) 1) icy)", & iy, & iy, 1);
      } else {
        setBranchInfo(12, 0, 1);
        setTrueExpr(12, "(< icy 0)");
        setFalseExpr(12, "(not (< icy 0))");
        addToTree(12, 3, "(< icy 0)", "(not (< icy 0))", 8, 0);
        delete_allVariableTableEntry();
      }
      }
      i___0 = 0;
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(16, "(< i___0 n)");
        setFalseExpr(16, "(not (< i___0 n))");
        addToTree(16, 3, "(< i___0 n)", "(not (< i___0 n))", 8, 1);
        delete_allVariableTableEntry();
        dtemp += *(dx + ix) * *(dy + iy);
        addEntryToVariableTable("*(dx + ix)", ix);
        add_entryToArraySTable("dx", ix, "dx196", dx + ix, dx + ix, 1);
        addEntryToVariableTable("*(dy + iy)", iy);
        add_entryToArraySTable("dy", iy, "dy197", dy + iy, dy + iy, 1);
        handleAssignmentSymbolically("dtemp", "(+ dtemp (* *(dx + ix) *(dy + iy)))",
                                     & dtemp, & dtemp, 1);
        ix += icx;
        ...
        setTrueExpr(16, "(< i___0 n)");
        setFalseExpr(16, "(not (< i___0 n))");
        addToTree(16, 3, "(< i___0 n)", "(not (< i___0 n))", 8, 0);
        delete_allVariableTableEntry();
      }
      }
      {
      ...
      if (overall_outcome) {
        ...
        setTrueExpr(18, "(< i___0 n)");
        setFalseExpr(18, "(not (< i___0 n))");
        addToTree(18, 3, "(< i___0 n)", "(not (< i___0 n))", 8, 1);
        delete_allVariableTableEntry();
        dtemp += *(dx + ix) * *(dy + iy);
        addEntryToVariableTable("*(dx + ix)", ix);
        add_entryToArraySTable("dx", ix, "dx198", dx + ix, dx + ix, 1);
        addEntryToVariableTable("*(dy + iy)", iy);
        add_entryToArraySTable("dy", iy, "dy199", dy + iy, dy + iy, 1);
        handleAssignmentSymbolically("dtemp", "(+ dtemp (* *(dx + ix) *(dy + iy)))",
                                     & dtemp, & dtemp, 1);
        ix += icx;
        handleAssignmentSymbolically("ix", "(+ ix icx)", & ix, & ix, 1);
        ...
        setTrueExpr(18, "(< i___0 n)");
        setFalseExpr(18, "(not (< i___0 n))");
        addToTree(18, 3, "(< i___0 n)", "(not (< i___0 n))", 8, 0);
        delete_allVariableTableEntry();
      }
      }
      }
      ...
      if (__cil_tmp13) {
        ...
        __cil_tmp13 = startCDG();
        add_entryToSTable("__cil_tmp13", "Function", & __cil_tmp13, & __cil_tmp13,
                          1);
        add_entryToSTable("__cil_tmp13", "Function", & __cil_tmp13, & __cil_tmp13,
                          1);
        add_entryToSTable("__cil_tmp13", "Function", & __cil_tmp13, & __cil_tmp13,
      ...
      setTrueExpr(8, "(not (= icy 1))");
      setFalseExpr(8, "(not (not (= icy 1)))");
      addToTree(8, 2, "(not (= icy 1))", "(not (not (= icy 1)))", 6, 0);
      delete_allVariableTableEntry();
    }
    }
  }
  ...
  if (overall_outcome) {
    ...
    delete_allVariableTableEntry();
    dtemp += *(dx + i___0) * *(dy + i___0);
    addEntryToVariableTable("*(dx + i___0)", i___0);
    add_entryToArraySTable("dx", i___0, "dx1100", dx + i___0, dx + i___0, 1);
    addEntryToVariableTable("*(dy + i___0)", i___0);
    add_entryToArraySTable("dy", i___0, "dy1101", dy + i___0, dy + i___0, 1);
    handleAssignmentSymbolically("dtemp", "(+ dtemp (* *(dx + i___0) *(dy + i___0)))",
                                 & dtemp, & dtemp, 1);
    i___0 ++;
    handleAssignmentSymbolically("i___0", "(+ i___0 1)", & i___0, & i___0, 1);
  } else {
  ...
  if (overall_outcome) {
    ...
    setTrueExpr(25, "(< i___0 n)");
    setFalseExpr(25, "(not (< i___0 n))");
    addToTree(25, 1, "(< i___0 n)", "(not (< i___0 n))", 0, 1);
    delete_allVariableTableEntry();
    dtemp += *(dx + i___0) * *(dy + i___0);
    addEntryToVariableTable("*(dx + i___0)", i___0);
    add_entryToArraySTable("dx", i___0, "dx1102", dx + i___0, dx + i___0, 1);
    addEntryToVariableTable("*(dy + i___0)", i___0);
    add_entryToArraySTable("dy", i___0, "dy1103", dy + i___0, dy + i___0, 1);
    handleAssignmentSymbolically("dtemp", "(+ dtemp (* *(dx + i___0) *(dy + i___0)))",
                                 & dtemp, & dtemp, 1);
    i___0 ++;
    handleAssignmentSymbolically("i___0", "(+ i___0 1)", & i___0, & i___0, 1);
    ...
    setTrueExpr(25, "(< i___0 n)");
    setFalseExpr(25, "(not (< i___0 n))");
    addToTree(25, 1, "(< i___0 n)", "(not (< i___0 n))", 0, 0);
    delete_allVariableTableEntry();
  }
  }
  }
...
int idamax(int idamax_n , int *idamax_dx , int idamax_icx )
{
  ...
  int idamax_itemp ;
  double idamax_tmp ;
  double idamax_tmp___0 ;
  double idamax_tmp___1 ;
  double idamax_tmp___2 ;
  double idamax_tmp___3 ;
  double idamax_tmp___4 ;
  int idamax___cil_tmp15 ;
  int idamax___cil_tmp16 ;
  char *symName ;
  void *addr ;
  char in[15] ;
  ...
  if (idamax_n < 1) {
    {
    idamax___cil_tmp15 = -1;
    add_entryToSTable("idamax___cil_tmp15", "Constant", & idamax___cil_tmp15, & idamax___cil_tmp15,
                      1);
    {
    mapConcolicValues("idamax___cil_tmp15", & idamax___cil_tmp15);
    return (idamax___cil_tmp15);
    }
    }
  }
  if (idamax_n == 1) {
    {
    idamax___cil_tmp16 = 0;
    add_entryToSTable("idamax___cil_tmp16", "Constant", & idamax___cil_tmp16, & idamax___cil_tmp16,
                      1);
    {
    mapConcolicValues("idamax___cil_tmp16", & idamax___cil_tmp16);
    return (idamax___cil_tmp16);
    }
    }
  }
  if (idamax_icx != 1) {
    idamax_ix = 1;
    add_entryToSTable("idamax_ix", "Constant", & idamax_ix, & idamax_ix, 1);
    idamax_tmp = fabs((double )*(idamax_dx + 0));
    add_entryToSTable("idamax_tmp", "Function", & idamax_tmp, & idamax_tmp, 2);
    idamax_dmax = (int )idamax_tmp;
    handleAssignmentSymbolically("idamax_dmax", "idamax_tmp", & idamax_dmax, & idamax_dmax,
                                 1);
    idamax_ix += idamax_icx;
    handleAssignmentSymbolically("idamax_ix", "(+ idamax_ix idamax_icx)", & idamax_ix,
                                 & idamax_ix, 1);
    idamax_i___0 = 1;
    ...
    if (idamax_i___0 < idamax_n) {
      idamax_tmp___0 = fabs((double )*(idamax_dx + idamax_ix));
      add_entryToSTable("idamax_tmp___0", "Function", & idamax_tmp___0, & idamax_tmp___0,
                        2);
      idamax_temp1 = (int )idamax_tmp___0;
      handleAssignmentSymbolically("idamax_temp1", "idamax_tmp___0", & idamax_temp1,
                                   & idamax_temp1, 1);
      if (idamax_temp1 > idamax_dmax) {
        idamax_itemp = idamax_i___0;
        handleAssignmentSymbolically("idamax_itemp", "idamax_i___0", & idamax_i___0,
                                     & idamax_i___0, 1);
        idamax_tmp___1 = fabs((double )*(idamax_dx + idamax_ix));
        add_entryToSTable("idamax_tmp___1", "Function", & idamax_tmp___1, & idamax_tmp___1,
                          2);
        idamax_dmax = (int )idamax_tmp___1;
        handleAssignmentSymbolically("idamax_dmax", "idamax_tmp___1", & idamax_dmax,
                                     & idamax_dmax, 1);
      }
      idamax_ix += idamax_icx;
      handleAssignmentSymbolically("idamax_ix", "(+ idamax_ix idamax_icx)", & idamax_ix,
    ...
    add_entryToSTable("idamax_itemp", "Constant", & idamax_itemp, & idamax_itemp,
                      1);
    idamax_tmp___2 = fabs((double )*(idamax_dx + 0));
    add_entryToSTable("idamax_tmp___2", "Function", & idamax_tmp___2, & idamax_tmp___2,
                      2);
    idamax_dmax = (int )idamax_tmp___2;
    handleAssignmentSymbolically("idamax_dmax", "idamax_tmp___2", & idamax_dmax, & idamax_dmax,
                                 1);
    idamax_i___0 = 1;
    add_entryToSTable("idamax_i___0", "Constant", & idamax_i___0, & idamax_i___0,
                      1);
    {
    if (idamax_i___0 < idamax_n) {
      idamax_tmp___3 = fabs((double )*(idamax_dx + idamax_i___0));
      add_entryToSTable("idamax_tmp___3", "Function", & idamax_tmp___3, & idamax_tmp___3,
                        2);
      idamax_temp1 = (int )idamax_tmp___3;
      handleAssignmentSymbolically("idamax_temp1", "idamax_tmp___3", & idamax_temp1,
                                   & idamax_temp1, 1);
      if (idamax_temp1 > idamax_dmax) {
        idamax_itemp = idamax_i___0;
        handleAssignmentSymbolically("idamax_itemp", "idamax_i___0", & idamax_i___0,
                                     & idamax_i___0, 1);
        idamax_tmp___4 = fabs((double )*(idamax_dx + idamax_i___0));
        add_entryToSTable("idamax_tmp___4", "Function", & idamax_tmp___4, & idamax_tmp___4,
                          2);
        idamax_dmax = (int )idamax_tmp___4;
        handleAssignmentSymbolically("idamax_dmax", "idamax_tmp___4", & idamax_dmax,
                                     & idamax_dmax, 1);
      }
      idamax_i___0 ++;
      handleAssignmentSymbolically("idamax_i___0", "(+ idamax_i___0 1)", & idamax_i___0,
...
void callInstrumentedFun(void)
{
  ...
  {
  enQueue();
  ddot_r(argvar.mempool, argvar.n, argvar.dx, argvar.icx, argvar.dy, argvar.icy);
}
}
void main(void)
{
  ...
  while (1) {
    if (__cil_tmp7 >= 30) {
      ...
      temp = rand();
      *(argvar.mempool + __cil_tmp7) = temp % 20;
      __cil_tmp7 ++;
    }
  }
  __cil_tmp6 = rand();
