...
int foo2(int foo2_a , int foo2_b )
{
  ...
  handleAssignmentSymbolically("foo2_a", "(+ foo2_a foo2_b)", & foo2_a, & foo2_a,
                               1);
  {
  mapConcolicValues("foo2_a", & foo2_a);
  return (foo2_a);
  }
}
}
int foo1(int foo1_x , int foo1_y , int foo1_z )
{
  ...
  handleAssignmentSymbolically("foo1_x", "(* foo1_x foo1_y)", & foo1_x, & foo1_x,
                               1);
  funcEntry("(int,foo2_a,variable,foo1_x) (int,foo2_b,variable,foo1_z)", "", "foo2");
  foo1_x = foo2(foo1_x, foo1_z);
  funcExit();
  add_entryToSTable("foo1_x", ret_SymValue, ret_ConValue, & foo1_x, 1);
  {
  mapConcolicValues("foo1_x", & foo1_x);
  return (foo1_x);
  }
}
}
...
int main1(int a )
{
  ...
  printTestCase("constantFunc_main1_1434147171.tc", __cil_tmp9);
  ...
  funcEntry("(int,foo1_x,variable,a) (int,foo1_y,variable,__cil_tmp4) (int,foo1_z,variable,__cil_tmp5)",
            "", "foo1");
  a = foo1(a, __cil_tmp4, __cil_tmp5);
  funcExit();
