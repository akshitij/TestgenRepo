...
#pragma merger("0","./tripleVerify.i","-g,-g")
...
int main1(int a )
{
  ...
  printTestCase("tripleVerify_main1_1433171667.tc", __cil_tmp7);
  add_entryToSTable("a", "s0", & a, & a, 1);
  n = 3 * a;
  handleAssignmentSymbolically("n", "(* 3 a)", & n, & n, 1);
  a = n;
  handleAssignmentSymbolically("a", "n", & n, & n, 1);
  {
  exp_outcome = a == 45;
