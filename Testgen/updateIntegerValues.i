# 1 "src/src/updateIntegerValues.c"
...
# 2 "src/src/updateIntegerValues.h" 2
...
# 3 "src/src/updateIntegerValues.h" 2
...
# 4 "src/src/updateIntegerValues.h" 2
...
# 2 "src/src/updateIntegerValues.c" 2
...
void createCDG();
# 3 "src/src/updateIntegerValues.c" 2
...
# 4 "src/src/updateIntegerValues.c" 2
# 1 "src/src/ipaRecursive.c" 1
...
# 5 "src/src/updateIntegerValues.c" 2

struct intVartable *itable = ((void *)0);
struct floatVartable *ftable = ((void *)0);

void addToIntTable(char *sname, int *val) {

  struct intVartable *s;

  do { unsigned _hf_bkt,_hf_hashv; s=((void *)0); if (itable) { do { unsigned _hj_i,_hj_j,_hj_k; unsigned char *_hj_key=(unsigned char*)(sname); _hf_hashv = 0xfeedbeef; _hj_i = _hj_j = 0x9e3779b9; _hj_k = (unsigned)(strlen(sname)); while (_hj_k >= 12) { _hj_i += (_hj_key[0] + ( (unsigned)_hj_key[1] << 8 ) + ( (unsigned)_hj_key[2] << 16 ) + ( (unsigned)_hj_key[3] << 24 ) ); _hj_j += (_hj_key[4] + ( (unsigned)_hj_key[5] << 8 ) + ( (unsigned)_hj_key[6] << 16 ) + ( (unsigned)_hj_key[7] << 24 ) ); _hf_hashv += (_hj_key[8] + ( (unsigned)_hj_key[9] << 8 ) + ( (unsigned)_hj_key[10] << 16 ) + ( (unsigned)_hj_key[11] << 24 ) ); do { _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 13 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 12 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 3 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 15 ); } while (0); _hj_key += 12; _hj_k -= 12; } _hf_hashv += strlen(sname); switch ( _hj_k ) { case 11: _hf_hashv += ( (unsigned)_hj_key[10] << 24 ); case 10: _hf_hashv += ( (unsigned)_hj_key[9] << 16 ); case 9: _hf_hashv += ( (unsigned)_hj_key[8] << 8 ); case 8: _hj_j += ( (unsigned)_hj_key[7] << 24 ); case 7: _hj_j += ( (unsigned)_hj_key[6] << 16 ); case 6: _hj_j += ( (unsigned)_hj_key[5] << 8 ); case 5: _hj_j += _hj_key[4]; case 4: _hj_i += ( (unsigned)_hj_key[3] << 24 ); case 3: _hj_i += ( (unsigned)_hj_key[2] << 16 ); case 2: _hj_i += ( (unsigned)_hj_key[1] << 8 ); case 1: _hj_i += _hj_key[0]; } do { _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 13 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 12 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 3 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 15 ); } while (0); _hf_bkt = _hf_hashv & ((itable)->hh.tbl->num_buckets-1); } while(0); if ((1)) { do { if ((itable)->hh.tbl->buckets[ _hf_bkt ].hh_head) do { (s) = (__typeof(s))(((void*)(((char*)((itable)->hh.tbl->buckets[ _hf_bkt ].hh_head)) - (((itable)->hh.tbl)->hho)))); } while(0); else s=((void *)0); while (s) { if ((s)->hh.keylen == strlen(sname)) { if ((memcmp((s)->hh.key,sname,strlen(sname))) == 0) break; } if ((s)->hh.hh_next) do { (s) = (__typeof(s))(((void*)(((char*)((s)->hh.hh_next)) - (((itable)->hh.tbl)->hho)))); } while(0); else s = ((void *)0); } } while(0); } } } while (0);
 ...
 if(CDG_Module==1){
  if (s == ((void *)0)) {
    ...
    do { unsigned _ha_bkt; (s)->hh.next = ((void *)0); (s)->hh.key = (char*)(&((s)->sname[0])); (s)->hh.keylen = (unsigned)(strlen(s->sname)); if (!(itable)) { itable = (s); (itable)->hh.prev = ((void *)0); do { (itable)->hh.tbl = (UT_hash_table*)malloc(sizeof(UT_hash_table)); if (!((itable)->hh.tbl)) { exit(-1); } memset((itable)->hh.tbl, 0, sizeof(UT_hash_table)); (itable)->hh.tbl->tail = &((itable)->hh); (itable)->hh.tbl->num_buckets = 32; (itable)->hh.tbl->log2_num_buckets = 5; (itable)->hh.tbl->hho = (char*)(&(itable)->hh) - (char*)(itable); (itable)->hh.tbl->buckets = (UT_hash_bucket*)malloc(32*sizeof(struct UT_hash_bucket)); if (! (itable)->hh.tbl->buckets) { exit(-1); } memset((itable)->hh.tbl->buckets, 0, 32*sizeof(struct UT_hash_bucket)); ; (itable)->hh.tbl->signature = 0xa0111fe1; } while(0); } else { (itable)->hh.tbl->tail->next = (s); (s)->hh.prev = ((void*)(((char*)((itable)->hh.tbl->tail)) - (((itable)->hh.tbl)->hho))); (itable)->hh.tbl->tail = &((s)->hh); } (itable)->hh.tbl->num_items++; (s)->hh.tbl = (itable)->hh.tbl; do { unsigned _hj_i,_hj_j,_hj_k; unsigned char *_hj_key=(unsigned char*)(&((s)->sname[0])); (s)->hh.hashv = 0xfeedbeef; _hj_i = _hj_j = 0x9e3779b9; _hj_k = (unsigned)(strlen(s->sname)); while (_hj_k >= 12) { _hj_i += (_hj_key[0] + ( (unsigned)_hj_key[1] << 8 ) + ( (unsigned)_hj_key[2] << 16 ) + ( (unsigned)_hj_key[3] << 24 ) ); _hj_j += (_hj_key[4] + ( (unsigned)_hj_key[5] << 8 ) + ( (unsigned)_hj_key[6] << 16 ) + ( (unsigned)_hj_key[7] << 24 ) ); (s)->hh.hashv += (_hj_key[8] + ( (unsigned)_hj_key[9] << 8 ) + ( (unsigned)_hj_key[10] << 16 ) + ( (unsigned)_hj_key[11] << 24 ) ); do { _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 13 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 12 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 3 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 15 ); } while (0); _hj_key += 12; _hj_k -= 12; } (s)->hh.hashv += strlen(s->sname); switch ( _hj_k ) { case 11: (s)->hh.hashv += ( (unsigned)_hj_key[10] << 24 ); case 10: (s)->hh.hashv += ( (unsigned)_hj_key[9] << 16 ); case 9: (s)->hh.hashv += ( (unsigned)_hj_key[8] << 8 ); case 8: _hj_j += ( (unsigned)_hj_key[7] << 24 ); case 7: _hj_j += ( (unsigned)_hj_key[6] << 16 ); case 6: _hj_j += ( (unsigned)_hj_key[5] << 8 ); case 5: _hj_j += _hj_key[4]; case 4: _hj_i += ( (unsigned)_hj_key[3] << 24 ); case 3: _hj_i += ( (unsigned)_hj_key[2] << 16 ); case 2: _hj_i += ( (unsigned)_hj_key[1] << 8 ); case 1: _hj_i += _hj_key[0]; } do { _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 13 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 12 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 3 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 15 ); } while (0); _ha_bkt = (s)->hh.hashv & ((itable)->hh.tbl->num_buckets-1); } while(0); do { (itable)->hh.tbl->buckets[_ha_bkt].count++; (&(s)->hh)->hh_next = (itable)->hh.tbl->buckets[_ha_bkt].hh_head; (&(s)->hh)->hh_prev = ((void *)0); if ((itable)->hh.tbl->buckets[_ha_bkt].hh_head) { ((itable)->hh.tbl->buckets[_ha_bkt]).hh_head->hh_prev = (&(s)->hh); } ((itable)->hh.tbl->buckets[_ha_bkt]).hh_head=&(s)->hh; if ((itable)->hh.tbl->buckets[_ha_bkt].count >= (((itable)->hh.tbl->buckets[_ha_bkt].expand_mult+1) * 10) && (&(s)->hh)->tbl->noexpand != 1) { do { unsigned _he_bkt; unsigned _he_bkt_i; struct UT_hash_handle *_he_thh, *_he_hh_nxt; UT_hash_bucket *_he_new_buckets, *_he_newbkt; _he_new_buckets = (UT_hash_bucket*)malloc(2 * (&(s)->hh)->tbl->num_buckets * sizeof(struct UT_hash_bucket)); if (!_he_new_buckets) { exit(-1); } memset(_he_new_buckets, 0, 2 * (&(s)->hh)->tbl->num_buckets * sizeof(struct UT_hash_bucket)); (&(s)->hh)->tbl->ideal_chain_maxlen = ((&(s)->hh)->tbl->num_items >> ((&(s)->hh)->tbl->log2_num_buckets+1)) + (((&(s)->hh)->tbl->num_items & (((&(s)->hh)->tbl->num_buckets*2)-1)) ? 1 : 0); (&(s)->hh)->tbl->nonideal_items = 0; for(_he_bkt_i = 0; _he_bkt_i < (&(s)->hh)->tbl->num_buckets; _he_bkt_i++) { _he_thh = (&(s)->hh)->tbl->buckets[ _he_bkt_i ].hh_head; while (_he_thh) { _he_hh_nxt = _he_thh->hh_next; do { _he_bkt = ((_he_thh->hashv) & (((&(s)->hh)->tbl->num_buckets*2) - 1)); } while(0); _he_newbkt = &(_he_new_buckets[ _he_bkt ]); if (++(_he_newbkt->count) > (&(s)->hh)->tbl->ideal_chain_maxlen) { (&(s)->hh)->tbl->nonideal_items++; _he_newbkt->expand_mult = _he_newbkt->count / (&(s)->hh)->tbl->ideal_chain_maxlen; } _he_thh->hh_prev = ((void *)0); _he_thh->hh_next = _he_newbkt->hh_head; if (_he_newbkt->hh_head) _he_newbkt->hh_head->hh_prev = _he_thh; _he_newbkt->hh_head = _he_thh; _he_thh = _he_hh_nxt; } } free((&(s)->hh)->tbl->buckets); (&(s)->hh)->tbl->num_buckets *= 2; (&(s)->hh)->tbl->log2_num_buckets++; (&(s)->hh)->tbl->buckets = _he_new_buckets; (&(s)->hh)->tbl->ineff_expands = ((&(s)->hh)->tbl->nonideal_items > ((&(s)->hh)->tbl->num_items >> 1)) ? ((&(s)->hh)->tbl->ineff_expands+1) : 0; if ((&(s)->hh)->tbl->ineff_expands > 1) { (&(s)->hh)->tbl->noexpand=1; ; } ; } while(0); } } while(0); ; ; ; } while(0);
...
void addToFloatTable(char *sname, float *val) {
  ...
  do { unsigned _hf_bkt,_hf_hashv; s=((void *)0); if (ftable) { do { unsigned _hj_i,_hj_j,_hj_k; unsigned char *_hj_key=(unsigned char*)(sname); _hf_hashv = 0xfeedbeef; _hj_i = _hj_j = 0x9e3779b9; _hj_k = (unsigned)(strlen(sname)); while (_hj_k >= 12) { _hj_i += (_hj_key[0] + ( (unsigned)_hj_key[1] << 8 ) + ( (unsigned)_hj_key[2] << 16 ) + ( (unsigned)_hj_key[3] << 24 ) ); _hj_j += (_hj_key[4] + ( (unsigned)_hj_key[5] << 8 ) + ( (unsigned)_hj_key[6] << 16 ) + ( (unsigned)_hj_key[7] << 24 ) ); _hf_hashv += (_hj_key[8] + ( (unsigned)_hj_key[9] << 8 ) + ( (unsigned)_hj_key[10] << 16 ) + ( (unsigned)_hj_key[11] << 24 ) ); do { _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 13 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 12 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 3 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 15 ); } while (0); _hj_key += 12; _hj_k -= 12; } _hf_hashv += strlen(sname); switch ( _hj_k ) { case 11: _hf_hashv += ( (unsigned)_hj_key[10] << 24 ); case 10: _hf_hashv += ( (unsigned)_hj_key[9] << 16 ); case 9: _hf_hashv += ( (unsigned)_hj_key[8] << 8 ); case 8: _hj_j += ( (unsigned)_hj_key[7] << 24 ); case 7: _hj_j += ( (unsigned)_hj_key[6] << 16 ); case 6: _hj_j += ( (unsigned)_hj_key[5] << 8 ); case 5: _hj_j += _hj_key[4]; case 4: _hj_i += ( (unsigned)_hj_key[3] << 24 ); case 3: _hj_i += ( (unsigned)_hj_key[2] << 16 ); case 2: _hj_i += ( (unsigned)_hj_key[1] << 8 ); case 1: _hj_i += _hj_key[0]; } do { _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 13 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 12 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= _hf_hashv; _hj_i ^= ( _hf_hashv >> 3 ); _hj_j -= _hf_hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); _hf_hashv -= _hj_i; _hf_hashv -= _hj_j; _hf_hashv ^= ( _hj_j >> 15 ); } while (0); _hf_bkt = _hf_hashv & ((ftable)->hh.tbl->num_buckets-1); } while(0); if ((1)) { do { if ((ftable)->hh.tbl->buckets[ _hf_bkt ].hh_head) do { (s) = (__typeof(s))(((void*)(((char*)((ftable)->hh.tbl->buckets[ _hf_bkt ].hh_head)) - (((ftable)->hh.tbl)->hho)))); } while(0); else s=((void *)0); while (s) { if ((s)->hh.keylen == strlen(sname)) { if ((memcmp((s)->hh.key,sname,strlen(sname))) == 0) break; } if ((s)->hh.hh_next) do { (s) = (__typeof(s))(((void*)(((char*)((s)->hh.hh_next)) - (((ftable)->hh.tbl)->hho)))); } while(0); else s = ((void *)0); } } while(0); } } } while (0);
  if (s == ((void *)0)) {
    s = (struct floatVartable *)malloc(sizeof(struct floatVartable));
    s->sname = (char *)malloc(sizeof(char) * (strlen(sname) + 1));
    strcpy(s->sname, sname);
    do { unsigned _ha_bkt; (s)->hh.next = ((void *)0); (s)->hh.key = (char*)(&((s)->sname[0])); (s)->hh.keylen = (unsigned)(strlen(s->sname)); if (!(ftable)) { ftable = (s); (ftable)->hh.prev = ((void *)0); do { (ftable)->hh.tbl = (UT_hash_table*)malloc(sizeof(UT_hash_table)); if (!((ftable)->hh.tbl)) { exit(-1); } memset((ftable)->hh.tbl, 0, sizeof(UT_hash_table)); (ftable)->hh.tbl->tail = &((ftable)->hh); (ftable)->hh.tbl->num_buckets = 32; (ftable)->hh.tbl->log2_num_buckets = 5; (ftable)->hh.tbl->hho = (char*)(&(ftable)->hh) - (char*)(ftable); (ftable)->hh.tbl->buckets = (UT_hash_bucket*)malloc(32*sizeof(struct UT_hash_bucket)); if (! (ftable)->hh.tbl->buckets) { exit(-1); } memset((ftable)->hh.tbl->buckets, 0, 32*sizeof(struct UT_hash_bucket)); ; (ftable)->hh.tbl->signature = 0xa0111fe1; } while(0); } else { (ftable)->hh.tbl->tail->next = (s); (s)->hh.prev = ((void*)(((char*)((ftable)->hh.tbl->tail)) - (((ftable)->hh.tbl)->hho))); (ftable)->hh.tbl->tail = &((s)->hh); } (ftable)->hh.tbl->num_items++; (s)->hh.tbl = (ftable)->hh.tbl; do { unsigned _hj_i,_hj_j,_hj_k; unsigned char *_hj_key=(unsigned char*)(&((s)->sname[0])); (s)->hh.hashv = 0xfeedbeef; _hj_i = _hj_j = 0x9e3779b9; _hj_k = (unsigned)(strlen(s->sname)); while (_hj_k >= 12) { _hj_i += (_hj_key[0] + ( (unsigned)_hj_key[1] << 8 ) + ( (unsigned)_hj_key[2] << 16 ) + ( (unsigned)_hj_key[3] << 24 ) ); _hj_j += (_hj_key[4] + ( (unsigned)_hj_key[5] << 8 ) + ( (unsigned)_hj_key[6] << 16 ) + ( (unsigned)_hj_key[7] << 24 ) ); (s)->hh.hashv += (_hj_key[8] + ( (unsigned)_hj_key[9] << 8 ) + ( (unsigned)_hj_key[10] << 16 ) + ( (unsigned)_hj_key[11] << 24 ) ); do { _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 13 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 12 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 3 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 15 ); } while (0); _hj_key += 12; _hj_k -= 12; } (s)->hh.hashv += strlen(s->sname); switch ( _hj_k ) { case 11: (s)->hh.hashv += ( (unsigned)_hj_key[10] << 24 ); case 10: (s)->hh.hashv += ( (unsigned)_hj_key[9] << 16 ); case 9: (s)->hh.hashv += ( (unsigned)_hj_key[8] << 8 ); case 8: _hj_j += ( (unsigned)_hj_key[7] << 24 ); case 7: _hj_j += ( (unsigned)_hj_key[6] << 16 ); case 6: _hj_j += ( (unsigned)_hj_key[5] << 8 ); case 5: _hj_j += _hj_key[4]; case 4: _hj_i += ( (unsigned)_hj_key[3] << 24 ); case 3: _hj_i += ( (unsigned)_hj_key[2] << 16 ); case 2: _hj_i += ( (unsigned)_hj_key[1] << 8 ); case 1: _hj_i += _hj_key[0]; } do { _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 13 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 8 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 13 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 12 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 16 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 5 ); _hj_i -= _hj_j; _hj_i -= (s)->hh.hashv; _hj_i ^= ( (s)->hh.hashv >> 3 ); _hj_j -= (s)->hh.hashv; _hj_j -= _hj_i; _hj_j ^= ( _hj_i << 10 ); (s)->hh.hashv -= _hj_i; (s)->hh.hashv -= _hj_j; (s)->hh.hashv ^= ( _hj_j >> 15 ); } while (0); _ha_bkt = (s)->hh.hashv & ((ftable)->hh.tbl->num_buckets-1); } while(0); do { (ftable)->hh.tbl->buckets[_ha_bkt].count++; (&(s)->hh)->hh_next = (ftable)->hh.tbl->buckets[_ha_bkt].hh_head; (&(s)->hh)->hh_prev = ((void *)0); if ((ftable)->hh.tbl->buckets[_ha_bkt].hh_head) { ((ftable)->hh.tbl->buckets[_ha_bkt]).hh_head->hh_prev = (&(s)->hh); } ((ftable)->hh.tbl->buckets[_ha_bkt]).hh_head=&(s)->hh; if ((ftable)->hh.tbl->buckets[_ha_bkt].count >= (((ftable)->hh.tbl->buckets[_ha_bkt].expand_mult+1) * 10) && (&(s)->hh)->tbl->noexpand != 1) { do { unsigned _he_bkt; unsigned _he_bkt_i; struct UT_hash_handle *_he_thh, *_he_hh_nxt; UT_hash_bucket *_he_new_buckets, *_he_newbkt; _he_new_buckets = (UT_hash_bucket*)malloc(2 * (&(s)->hh)->tbl->num_buckets * sizeof(struct UT_hash_bucket)); if (!_he_new_buckets) { exit(-1); } memset(_he_new_buckets, 0, 2 * (&(s)->hh)->tbl->num_buckets * sizeof(struct UT_hash_bucket)); (&(s)->hh)->tbl->ideal_chain_maxlen = ((&(s)->hh)->tbl->num_items >> ((&(s)->hh)->tbl->log2_num_buckets+1)) + (((&(s)->hh)->tbl->num_items & (((&(s)->hh)->tbl->num_buckets*2)-1)) ? 1 : 0); (&(s)->hh)->tbl->nonideal_items = 0; for(_he_bkt_i = 0; _he_bkt_i < (&(s)->hh)->tbl->num_buckets; _he_bkt_i++) { _he_thh = (&(s)->hh)->tbl->buckets[ _he_bkt_i ].hh_head; while (_he_thh) { _he_hh_nxt = _he_thh->hh_next; do { _he_bkt = ((_he_thh->hashv) & (((&(s)->hh)->tbl->num_buckets*2) - 1)); } while(0); _he_newbkt = &(_he_new_buckets[ _he_bkt ]); if (++(_he_newbkt->count) > (&(s)->hh)->tbl->ideal_chain_maxlen) { (&(s)->hh)->tbl->nonideal_items++; _he_newbkt->expand_mult = _he_newbkt->count / (&(s)->hh)->tbl->ideal_chain_maxlen; } _he_thh->hh_prev = ((void *)0); _he_thh->hh_next = _he_newbkt->hh_head; if (_he_newbkt->hh_head) _he_newbkt->hh_head->hh_prev = _he_thh; _he_newbkt->hh_head = _he_thh; _he_thh = _he_hh_nxt; } } free((&(s)->hh)->tbl->buckets); (&(s)->hh)->tbl->num_buckets *= 2; (&(s)->hh)->tbl->log2_num_buckets++; (&(s)->hh)->tbl->buckets = _he_new_buckets; (&(s)->hh)->tbl->ineff_expands = ((&(s)->hh)->tbl->nonideal_items > ((&(s)->hh)->tbl->num_items >> 1)) ? ((&(s)->hh)->tbl->ineff_expands+1) : 0; if ((&(s)->hh)->tbl->ineff_expands > 1) { (&(s)->hh)->tbl->noexpand=1; ; } ; } while(0); } } while(0); ; ; ; } while(0);
  s->value = val;
  }
  if(noInsertionInTables == 0)
    s->value = val;
...
struct floatVartable *curr1, *tmp1;
  ...
  for((curr)=(itable),(tmp)=(__typeof(curr))((itable)?(itable)->hh.next:((void *)0)); curr; (curr)=(tmp),(tmp)=(__typeof(curr))((tmp)?(tmp)->hh.next:((void *)0))) {
    do { unsigned _hd_bkt; struct UT_hash_handle *_hd_hh_del; if ( ((curr)->hh.prev == ((void *)0)) && ((curr)->hh.next == ((void *)0)) ) { free((itable)->hh.tbl->buckets); ; free((itable)->hh.tbl); itable = ((void *)0); } else { _hd_hh_del = &((curr)->hh); if ((curr) == ((void*)(((char*)((itable)->hh.tbl->tail)) - (((itable)->hh.tbl)->hho)))) { (itable)->hh.tbl->tail = (UT_hash_handle*)((ptrdiff_t)((curr)->hh.prev) + (itable)->hh.tbl->hho); } if ((curr)->hh.prev) { ((UT_hash_handle*)((ptrdiff_t)((curr)->hh.prev) + (itable)->hh.tbl->hho))->next = (curr)->hh.next; } else { do { (itable) = (__typeof(itable))((curr)->hh.next); } while(0); } if (_hd_hh_del->next) { ((UT_hash_handle*)((ptrdiff_t)_hd_hh_del->next + (itable)->hh.tbl->hho))->prev = _hd_hh_del->prev; } do { _hd_bkt = ((_hd_hh_del->hashv) & (((itable)->hh.tbl->num_buckets) - 1)); } while(0); ((itable)->hh.tbl->buckets[_hd_bkt]).count--; if (((itable)->hh.tbl->buckets[_hd_bkt]).hh_head == _hd_hh_del) { ((itable)->hh.tbl->buckets[_hd_bkt]).hh_head = _hd_hh_del->hh_next; } if (_hd_hh_del->hh_prev) { _hd_hh_del->hh_prev->hh_next = _hd_hh_del->hh_next; } if (_hd_hh_del->hh_next) { _hd_hh_del->hh_next->hh_prev = _hd_hh_del->hh_prev; }; (itable)->hh.tbl->num_items--; } ; } while (0);
    free(curr);
  }

 for((curr1)=(ftable),(tmp1)=(__typeof(curr1))((ftable)?(ftable)->hh.next:((void *)0)); curr1; (curr1)=(tmp1),(tmp1)=(__typeof(curr1))((tmp1)?(tmp1)->hh.next:((void *)0))) {
    do { unsigned _hd_bkt; struct UT_hash_handle *_hd_hh_del; if ( ((curr1)->hh.prev == ((void *)0)) && ((curr1)->hh.next == ((void *)0)) ) { free((ftable)->hh.tbl->buckets); ; free((ftable)->hh.tbl); ftable = ((void *)0); } else { _hd_hh_del = &((curr1)->hh); if ((curr1) == ((void*)(((char*)((ftable)->hh.tbl->tail)) - (((ftable)->hh.tbl)->hho)))) { (ftable)->hh.tbl->tail = (UT_hash_handle*)((ptrdiff_t)((curr1)->hh.prev) + (ftable)->hh.tbl->hho); } if ((curr1)->hh.prev) { ((UT_hash_handle*)((ptrdiff_t)((curr1)->hh.prev) + (ftable)->hh.tbl->hho))->next = (curr1)->hh.next; } else { do { (ftable) = (__typeof(ftable))((curr1)->hh.next); } while(0); } if (_hd_hh_del->next) { ((UT_hash_handle*)((ptrdiff_t)_hd_hh_del->next + (ftable)->hh.tbl->hho))->prev = _hd_hh_del->prev; } do { _hd_bkt = ((_hd_hh_del->hashv) & (((ftable)->hh.tbl->num_buckets) - 1)); } while(0); ((ftable)->hh.tbl->buckets[_hd_bkt]).count--; if (((ftable)->hh.tbl->buckets[_hd_bkt]).hh_head == _hd_hh_del) { ((ftable)->hh.tbl->buckets[_hd_bkt]).hh_head = _hd_hh_del->hh_next; } if (_hd_hh_del->hh_prev) { _hd_hh_del->hh_prev->hh_next = _hd_hh_del->hh_next; } if (_hd_hh_del->hh_next) { _hd_hh_del->hh_next->hh_prev = _hd_hh_del->hh_prev; }; (ftable)->hh.tbl->num_items--; } ; } while (0);
    free(curr1);
  }
...
void writeProgramSVariables() {
  ...
  for (s = itable; s != ((void *)0); s = (struct intVartable *)(s->hh.next)) {
  ...
  for (s1 = ftable; s1 != ((void *)0); s1 = (struct floatVartable *)(s1->hh.next)) {
...
# 149 "src/src/updateIntegerValues.c"
  printFile(")\n");
}
