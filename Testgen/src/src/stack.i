...
void stackPush(Stack *s, const void *element) {
  ...
  ((((void *)0) != newHead) ? (void) (0) : __assert_fail ("((void *)0) != newHead", "src/src/stack.c", 15, __PRETTY_FUNCTION__));
  newHead->element = malloc(s->elementSize);
  ((((void *)0) != newHead->element) ? (void) (0) : __assert_fail ("((void *)0) != newHead->element", "src/src/stack.c", 17, __PRETTY_FUNCTION__));
...
void stackPop(Stack *s, void *element) {
  ((!stackIsEmpty(s)) ? (void) (0) : __assert_fail ("!stackIsEmpty(s)", "src/src/stack.c", 25, __PRETTY_FUNCTION__));
  node *top;
  top = s->head;
  s->head = s->head->next;
  s->elementsCnt--;
...
void stackPeek(Stack *s, void *element) {
  ((!stackIsEmpty(s)) ? (void) (0) : __assert_fail ("!stackIsEmpty(s)", "src/src/stack.c", 62, __PRETTY_FUNCTION__));
