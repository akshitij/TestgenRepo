...
{ 
  ...
  add_condition(6, "(> i___0 100)", "(not (> i___0 100))", 0, 0);
...
{ 
  ...
  printTestCase("loopTest_main1_1432390159.tc", __cil_tmp6);
  ...
  if (overall_outcome) {
    ...
    if (overall_outcome) {
      setBranchInfo(6, 1, 0);
      setTrueExpr(6, "(> i___0 100)");
      setFalseExpr(6, "(not (> i___0 100))");
      addToTree(6, 2, "(> i___0 100)", "(not (> i___0 100))", 2, 1);
      delete_allVariableTableEntry();
      j = 4;
      add_entryToSTable("j", "Constant", & j, & j, 1);
    } else {
      ...
      setTrueExpr(6, "(> i___0 100)");
      setFalseExpr(6, "(not (> i___0 100))");
      addToTree(6, 2, "(> i___0 100)", "(not (> i___0 100))", 2, 0);
      delete_allVariableTableEntry();
      j = 9;
      add_entryToSTable("j", "Constant", & j, & j, 1);
    }
